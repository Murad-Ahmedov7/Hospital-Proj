  ...
  return (
    <div className="w-full pt-[72px]">
      <div className="flex justify-center items-center relative">
        <img className="rounded-4xl w-[90%] min-h-screen" src="/images/pharmacy page/cyan-bg.png"/>
        <div className=" inner-content flex flex-col lg:gap-[40px] 2xl:gap-[80px]    absolute w-[77%] h-[80%] ">
            ...
            <div className="outer-right flex flex-col gap-9 w-[35%]">
              <div className="user-box flex w-full gap-4">
                 <div className="flex -space-x-5">
                  <img className="w-12 h-12 rounded-full border-cyan-400" src="/images/pharmacy page/users/user1.png" />
                  <img className="w-12 h-12 rounded-full border-cyan-400" src="/images/pharmacy page/users/user2.png" />
                  <img className="w-12 h-12 rounded-full border-cyan-400" src="/images/pharmacy page/users/user3.png" />
                  <img className="w-12 h-12 rounded-full border-cyan-400" src="/images/pharmacy page/users/user4.png" />
                 </div>
         ...
         <div className="row-down flex w-[97%] gap-5">
            <img className="rounded-2xl w-[65%] h-[100%]" src="/images/pharmacy page/banner-img1.jpg" alt="Picture not available" />
            <img className="rounded-2xl w-[35%] h-[100%]" src="/images/pharmacy page/banner-img2.jpg" alt="Picture not available" />
          </div>
