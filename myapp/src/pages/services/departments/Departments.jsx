...
export default function Department() {
 ...
 <div className="relative w-screen min-h-screen  ">
  <div className="absolute inset-0">
    <img
      src="/images/departments/surgeryimg.jpg"
...
<div className="flex absolute items-end  h-[640px] ">
  <Link to='/services/departments/doctor-timetable' className="bg-gradient-to-r from-[#babebe]   to-[#3AA6B9]
...
// /departments                   ← bütün department-lər
// /departments/:departmentId     ← seçilmiş department-dəki həkimlər
// /doctors/:doctorId/consultation  ← həkim seçildikdə consultation səhifəsi
