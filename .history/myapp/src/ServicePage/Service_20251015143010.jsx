...
export default function Service() {
  ...
  return (
    <div id="services" className="flex flex-col  min-h-screen bg-gradient-to-bl from-blue-300 via-gray-200 to-white   ">
      ...
      <div className="grid grid-cols-3 grid-rows-2  xl:px-41 2xl:px-74    gap-11  ">
        ...
        {services.map((service) => (
          <Link to={service.Link}
            key={service.id}
            className=" flex z-40 flex-col gap-5 py-7 px-10 border-1 border-white shadow-4  xl shadow-blue-300  transition transform hover:scale-110"  //burda isleyir hove scaleeeeee
          >
            <img
