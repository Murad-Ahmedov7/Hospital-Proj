    ...
    return (
        <div id="services" className="flex flex-col gap-12 min-h-screen ">
            ...
            <div className="grid grid-cols-3 grid-rows-2 ml-40 px-60 ">
                <div className=" bg-red-200  h-[330px] w-[350px] flex flex-col gap-5 p-5">
                ...
                <p className="font-mulish text-3xl font-bold">Search doctor</p>
                <p className="font-mulisg text-[20px] text-[#7D7987] px-22">Choose your doctor from thousands of specialist, general, and trusted hospitals</p>
                </div>
