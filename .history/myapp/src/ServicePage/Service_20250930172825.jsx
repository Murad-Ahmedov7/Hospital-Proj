            ...
            <div className="grid grid-cols-3 grid-rows-2 ml-40 px-60 ">
...

                {
                    services.map(() => {
                        ...
                        >
                            <img className="w-[100px] h-[100px]" src={service.img} alt={services.title} />
                            <p className="font-mulish text-[25px] font-bold text-center">{services.title}</p>
                            <p className="font-mulish text-[16px] text-[#7D7987] text-center">{services.desc}</p>
                        </div>
                    })
                }
            </div>
