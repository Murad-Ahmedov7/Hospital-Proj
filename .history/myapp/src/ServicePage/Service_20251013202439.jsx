    ...
    <div id="services" className="flex flex-col  min-h-screen  ">
      ...
      <div className="grid grid-cols-3 grid-rows-2  xl:px-41 2xl:px-74    gap-11  ">
        ...
        {services.map((service) => (
          <div
            key={service.id}
            className={`${service} flex flex-col gap-5 py-7 px-10 border-1 border-white shadow-lg shadow-black transition hover:scale-115`}  //burda isleyir hove scaleeeeee
          >
            <img
