    ...
    return (
        <div id="services" className="flex flex-col gap-12 min-h-screen ">
              ...
              <div className=" flex flex-col items-center">
                <p>Our Services</p>
                <p className="w-[800px]">We provide to you the best choiches for you. Adjust it to your health needs and make sure your undergo treatment with our highly qualified doctors you can consult with us which type of service is suitable for your health</p>
              </div>
