    ...
    return (
        <div id="services" className="flex flex-col gap-12 min-h-screen ">
            ...
            <div className="grid grid-cols-3 grid-rows-2  ">
                <div className=" bg-red-200  h-[330px] w-[440px]">1</div>
                <div className=" bg-blue-200  h-[330px] w-[340px]">2</div>
                <div className=" bg-green-200  h-[330px] w-[340px]">3</div>
                <div className=" bg-yellow-200  h-[330px] w-[340px]">4</div>
                <div className=" bg-purple-200  h-[330px] w-[340px]">5</div>
                <div className=" bg-pink-200  h-[330px] w-[340px]">6</div>
            </div>
