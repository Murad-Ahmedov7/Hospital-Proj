      ...
      <div className="grid grid-cols-3 grid-rows-2  xl:px-40 2xl:px-61    gap-11  ">
        {services.map((service) => (
          <Link to={service.Link}
            key={service.id}
            className=" flex z-40 flex-col gap-5 py-7 px-10 border-1 border-white shadow-2xl shadow-blue-300  transition transform hover:scale-110"  //burda isleyir hove scaleeeee
          >
            <img
