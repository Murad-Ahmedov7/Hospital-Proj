      ...
      <div className="grid grid-cols-3 grid-rows-2  xl:px-41 2xl:px-74    gap-11  ">
        ...
        {services.map((service) => (
          <Link to={service.Link}
            key={service.id}
            className=" flex z-40 flex-col gap-5 py-7 px-10 border-1 border-white shadow-lg shadow-blue-300  transition hover:scale-115`}"  //burda isleyir hove scaleeeeee
          >
            <img
