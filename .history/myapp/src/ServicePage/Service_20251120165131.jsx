...
export default function Service() {
  ...
  return (
    <div id="services" className="flex flex-col   min-h-screen bg-gradient-to-bl from-blue-300 to-white  2xl:min-h-[200px] 2xl:overflow-hidden   ">
      <div className=" flex flex-col items-center  pb-10 ml-5 mt-7 ">
      ...
      <div className="  grid  grid-cols-3 grid-rows-2  xl:px-40 2xl:px-61  gap-11 h-[20%]    ">
