...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
  <div className="relative w-[290px] min-h-[354px] max-h-[354px] flex justify-center items-center group rounded-2xl overflow-hidden">
    {/* Gradient border */}
    ...
    {/* Card content */}
    <div className="absolute flex flex-col items-center  gap-3  transition-transform duration-300 group-hover:scale-110 group-hover:translate-y-[-90px]">
