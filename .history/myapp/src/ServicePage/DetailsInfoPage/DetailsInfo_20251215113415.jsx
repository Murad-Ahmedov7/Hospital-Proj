...
<div className="relative flex flex-col lg:flex-row items-center bg-cyan-50 rounded-3xl shadow-xl p-8 lg:p-12 gap-8 lg:gap-12 overflow-hidden">
      
      {/* Sol tərəf: böyük vizual / şəkil */}
      <div className="flex-shrink-0 w-full lg:w-1/2 h-64 lg:h-[600px] relative">
        <img
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-cyan-500/80 to-transparent rounded-2xl"></div>
      </div>

      {/* Sağ tərəf: text və CTA */}
      <div className="flex flex-col gap-4 lg:gap-6 text-cyan-900 lg:w-1/2">
