...
<div class="relative w-[290px] h-[254px] flex justify-center items-center group">
  {/* <!-- Gradient border --> */}
  <div class="absolute inset-0 bg-gradient-to-br from-[#03a9f4] to-[#cfc7ca]"></div>
  {/* <!-- Glow --> */}
  <div class="absolute inset-0 bg-gradient-to-br from-[#03a9f4] to-[#858182] blur-[30px]"></div>
  {/* <!-- Dark overlay --> */}
  <div class="absolute inset-1 bg-white/60 z-20 rounded-sm"></div>
