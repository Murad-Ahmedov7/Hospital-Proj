 ...
 <div className="flex flex-col items-center bg-cyan-50 rounded-3xl shadow-xl p-8 lg:p-12 gap-8 lg:gap-12 overflow-hidden">

      {/* Hero şəkil */}
      <div className="flex-shrink-0 w-full lg:min-h-[3  00px] relative">
        <img
