  ...
  return (
    ...
    <div className="flex flex-col  rounded-3xl shadow-xl p-12 gap-12">
      ...
      <div className="grid grid-cols-3">
        <div class="relative w-[490px] h-[254px] flex justify-center items-center group-hover:bg-emerald-500">
          {/* <!-- Gradient border --> */}
          <div class="absolute inset-0 bg-gradient-to-br from-[#03a9f4] to-white"></div>
          {/* <!-- Glow --> */}
          <div class="absolute inset-0 bg-gradient-to-br from-[#03a9f4] to-white blur-[30px]"></div>
          {/* <!-- Dark overlay --> */}
          <div class="absolute inset-1 bg-black/20 z-20 rounded-sm"></div>
