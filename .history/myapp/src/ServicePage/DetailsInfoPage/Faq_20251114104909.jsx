          ...
          <div className="flex gap-10 justify-start w-[71vw] text-[#2d3549] font-oswald">  {/*row  div*/}
            ...
            <div>          {/*row each element  div*/}
              <div className="flex justify-between">
                  <p className=" text-xl   text-center font-oswald text-black/70">Why is a bone marrow transplant needed?</p>
            <FaChevronDown/>
              </div>
              <div className="border-1 border-black/15 w-[560px] mt-6 "></div>
            </div>   {/*row each element  div*/}
