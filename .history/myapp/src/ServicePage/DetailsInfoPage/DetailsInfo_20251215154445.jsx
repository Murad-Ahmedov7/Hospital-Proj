...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 ">
  <div className="relative w-[290px] h-[300px]  flex justify-center items-center group rounded-2xl overflow-hidden">
    {/* Gradient border */}
    <div className="absolute inset-0 bg-gradient-to-br from-[#03a9f4] to-red-200"></div>
    {/* Glow */}
    ...
    {/* Card content */}
    <div className="absolute flex flex-col items-center  gap-3  transition-transform duration-300 group-hover:scale-110 group-hover:translate-y-[-70px]">
      <FcDepartment size={70} />
      <p className="text-3xl lg:text-3xl font-semibold text-center text-white ">
        Department Overview
      </p>
    ...
    <div className="absolute flex flex-col items-center  gap-3  transition-transform duration-300 group-hover:scale-110 group-hover:translate-y-[-70px]">
      ...
      <p className="mt-2 w-[200px] text-white/70 text-center opacity-0 group-hover:opacity-100 hidden group-hover:block">
        ...
        <div className="absolute flex flex-col items-center  gap-3  transition-transform duration-300 group-hover:scale-110 group-hover:translate-y-[-10px]">
      <FcDepartment size={70} />
      <p className="text-3xl lg:text-3xl font-semibold text-center text-white ">
        Department Overview
      </p>
