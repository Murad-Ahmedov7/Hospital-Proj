...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 place-items-center  gap-4">

  {
    ...
    detailsInfoCards.map((d)=>(
        ...
        <div key={d.id} className="relative w-[290px] h-[320px]  flex justify-center items-center group rounded-2xl overflow-hidden transition-transform duration-300 hover: ">
    {/* Gradient border */}
