 ...
 <div className="flex flex-col items- min-h-screen bg-cyan-50  rounded-3xl shadow-xl  p-12 gap-12 ">

      {/* Hero şəkil */}
      <div className="flex-shrink-0 flex justify-center w-full h-[820px]  relative">
        <img
          src="/images/cheerful-medics-team-hospital_23-2147763833.jpg" // buraya öz şəkilini qoy
          alt="Hero Visual"
          className="w-[100%] h-full  rounded-2xl shadow-md object-cover"
        />
        {/* Overlay gradient */}
