...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
  <div className="relative w-[290px] h-[354px] flex justify-center items-center group rounded-2xl overflow-hidden">
    ...
    {/* Dark overlay */}
    <div className="absolute inset-0 bg-black/20 rounded-2xl transition-colors duration-300 group-hover:bg-black/4 0"></div>

    {/* Card content */}
    <div className="absolute flex flex-col items-center gap-3 z-10 transition-transform duration-300 group-hover:scale-105">
