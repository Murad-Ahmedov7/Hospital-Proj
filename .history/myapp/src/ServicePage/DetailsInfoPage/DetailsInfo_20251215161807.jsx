...
export default function DetailsInfo() {
  return (
    ...
    <div className="flex flex-col  rounded-3xl shadow-xl px-40 py-12 gap-12">
      {/* Hero şəkil */}
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 place-items-center  gap-4">

  {
    ...
    {/* Gradient border */}
    <div className="absolute inset-0 bg-gradient-to-br from-[#03a9f4] to-red-100"></div>
    {/* Glow */}
