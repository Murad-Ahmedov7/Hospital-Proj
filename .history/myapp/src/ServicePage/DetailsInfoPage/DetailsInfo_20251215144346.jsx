  ...
  return (
    ...
    <div className="flex flex-col  rounded-3xl shadow-xl p-12 gap-12">
      ...
      <div className="grid grid-cols-3">
        <div class="relative w-[390px] h-[354px] flex justify-center items-center group">
          {/* <!-- Gradient border --> */}
          <div class="absolute inset-0 bg-gradient-to-br from-[#03a9f4] to-white"></div>
          {/* <!-- Glow --> */}
          <div class="absolute inset-0 bg-gradient-to-br from-[#03a9f4] to-white blur-[120px]"></div>
          {/* <!-- Dark overlay --> */}
          <div class="absolute inset-1 bg-black/10 rounded-sm"></div>
<div className="absolute flex flex-col items-center gap-3">
  <img className="object-cover w-full h-full" src="/images/pexels-pixabay-236380.jpg" alt="" />
