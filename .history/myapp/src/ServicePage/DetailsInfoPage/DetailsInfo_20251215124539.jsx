 ...
 <div className="flex flex-col min-w-[70vw]  min-h-[70vh]  items-center bg-cyan-50  rounded-3xl shadow-xl  px-12 py-12  gap-12 ">

      {/* Hero şəkil */}
      <div className="flex-shrink-0  w-full min-h-[820px]  relative">
        <img
          src="/images/cheerful-medics-team-hospital_23-2147763833.jpg" // buraya öz şəkilini qoy
          alt="Hero Visual"
          className="w-full h-full  rounded-2xl shadow-md object-center  "
        />
        {/* Overlay gradient */}
