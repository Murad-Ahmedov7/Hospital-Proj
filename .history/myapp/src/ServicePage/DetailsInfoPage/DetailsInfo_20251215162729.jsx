...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 place-items-center  gap-4">

  {
    ...
    {/* Glow */}
    <div className="absolute inset-0 bg-gradient-to-br from-[#03a9f4] to-red-100 blur-[70px]"></div>
    {/* Dark overlay */}
    ...
    {/* Card content  */}
     <div className="absolute flex flex-col items-center  gap-3  transition-transform duration-300 group-hover:scale-130 group-hover:translate-y-[-15px]">
      ...
      <p className="mt-2 w-[200px] text-white/70 text-center opacity-0 group-hover:opacity-100 hidden group-hover:block">
      {d.buttonText}
      </p>
    </div>
