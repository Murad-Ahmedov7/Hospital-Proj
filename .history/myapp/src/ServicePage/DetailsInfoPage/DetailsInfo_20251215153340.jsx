...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
  <div className="relative w-[290px] h-[354px] flex justify-center items-center group rounded-2xl overflow-hidden">
    ...
    {/* Card content */}
    <div className="absolute flex flex-col items-center justify-center gap-3  transition-transform duration-300 group-hover:scale-110 group-hover:translate-y-[-100px]">
      <FcDepartment size={70} />
      <p className="text-3xl lg:text-3xl font-semibold text-center text-white">
        Department Overview
      </p>

      <p className="mt-2 w-[200px] text-white/70 text-center opacity-0 group-hover:opacity-100">
