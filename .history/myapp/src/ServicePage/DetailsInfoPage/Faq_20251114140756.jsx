...
export default function Faq() {
  ...
  const handleButton=(id)=>{
    const data1=faqData.find(f=>f.id===id)
console.log(JSON.stringify(data1.row[0]), ":::element tapidi");
              ...
              {item.row.map((qa, i) => (
                <div className="flex flex-col gap-4 " key={i}>
                  ...
                  <div className="flex justify-between">
                    ...
                    <div onClick={()=>handleButton(item.id)}><FaChevronDown /></div>
                  </div>
                  ...
                  <div className="border border-black/15 w-[660px]">
