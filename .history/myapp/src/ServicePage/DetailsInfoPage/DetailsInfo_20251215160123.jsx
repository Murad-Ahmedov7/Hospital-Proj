...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-1">
  <div className="relative w-[290px] h-[320px]  flex justify-center items-center group rounded-2xl overflow-hidden">
    {/* Gradient border */}
   {detailsInfoCards.map((d) => {
          ...
          return (
            <Link
              to={d.link}
              key={d.id}
              className="relative w-[290px] h-[320px] flex justify-center items-center group rounded-2xl overflow-hidden"
            >
              {/* Gradient border */}
              <div className="absolute inset-0 bg-gradient-to-br from-cyan-400 to-white" />

              {/* Glow */}
              <div className="absolute inset-0 bg-gradient-to-br from-cyan-400 to-white blur-[70px]" />

              {/* Dark overlay */}
              <div className="absolute inset-1 bg-black/10 rounded-2xl transition-colors duration-300 group-hover:bg-black/40" />

              {/* Card content */}
              <div className="relative z-10 flex flex-col items-center gap-3 transition-all duration-300 group-hover:scale-110 group-hover:-translate-y-6">
                <Icon size={70} />
                ...
                <p className="mt-2 w-[200px] text-white/70 text-center 
