  ...
  return (
    ...
    <div className="flex flex-col  rounded-3xl shadow-xl p-12 gap-12">
      ...
      <div className="grid grid-cols-3 ">
        <div classname="relative w-[290px] h-[354px] flex justify-center items-center hover:absolute inset-0 bg-black/40">
          {/* <!-- Gradient border --> */}
          <div classname="absolute inset-0 bg-gradient-to-br from-[#03a9f4] to-white"></div>
          {/* <!-- Glow --> */}
          <div classname="absolute inset-0 bg-gradient-to-br from-[#03a9f4] to-white blur-[120px]"></div>
          {/* <!-- Dark overlay --> */}
