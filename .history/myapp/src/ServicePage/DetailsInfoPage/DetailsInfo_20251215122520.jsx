...
<div className="flex flex-col items-center bg-cyan-50 rounded-3xl shadow-xl p-12 gap-12 overflow-hidden">
  ...
  <div className="flex items-center justify-center w-full h-[600px] relative">
    <img
      ...
      alt="Hero Visual"
      className="rounded-2xl shadow-md object-cover max-h-full max-w-full"
    />
