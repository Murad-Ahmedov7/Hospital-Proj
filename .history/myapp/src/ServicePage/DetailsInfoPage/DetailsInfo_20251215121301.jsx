 ...
 <div className="flex flex-col xl:flex-row items-center bg-cyan-50 rounded-3xl shadow-xl p-6 md:p-8 lg:p-12 gap-6 md:gap-8 lg:gap-12 overflow-hidden">

      {/* Hero şəkil */}
      <div className="flex-shrink-0 w-full xl:w-[60%] 2xl:w-[50%] h-64 sm:h-96 md:h-[500px] lg:h-[600px] relative">
        <img
      ...
      {/* Text və CTA */}
      <div className="flex flex-col gap-4 md:gap-6 text-cyan-900 w-full xl:w-[40%] 2xl:w-[50%]">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight">
          Plan your visit with ease
        </h1>

        <p className="text-sm sm:text-base md:text-lg lg:text-lg text-cyan-800 leading-relaxed">
        ...
        <div className="flex gap-4 mt-4 flex-wrap">
          <Link
            to="/"
            className="bg-cyan-500 text-white px-5 py-2 rounded-lg font-semibold hover:bg-cyan-600 transition flex items-center gap-2"
          >
            🏠 Back Home
          </Link>
          <Link
            to="/book-appointment"
            className="border border-cyan-500 text-cyan-500 px-5 py-2 rounded-lg font-semibold hover:bg-cyan-100 transition"
          >
            Book Appointment
          </Link>
        </div>
