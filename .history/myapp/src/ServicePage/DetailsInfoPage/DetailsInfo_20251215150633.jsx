  ...
  return (
    ...
    <div className="flex flex-col  rounded-3xl shadow-xl p-12 gap-12">
      ...
      <div className="grid grid-cols-3 ">
        <div className="relative w-[290px] h-[354px] flex justify-center items-center group  ">
          {/* <!-- Gradient border --> */}
          ...
          {/* <!-- Dark overlay --> */}
          <div className="absolute inset-1 bg-black/10 rounded-sm"></div>

          <div className="absolute inset-0 opacity-0 group-hover:opacity-100 bg-black/20 rounded-sm"></div>
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
  <div className="relative w-[290px] h-[354px] flex justify-center items-center group rounded-2xl overflow-hidden">
    ...
    <div className="absolute inset-0 bg-gradient-to-br from-[#03a9f4] to-white blur-[30px]"></div>
    {/* Dark overlay */}
    <div className="absolute inset-2 bg-black/10 rounded-2xl transition-colors duration-300 group-hover:bg-black/40"></div>
