...
<div className="flex gap-[80px] w-[100%] ">
...

  {
    ...
    detailsInfoCards.map((d)=>(
        ...
        <div key={d.id} className="relative    flex justify-center items-center group rounded-2xl overflow-hidden transition-transform duration-300 hover:translate-y-[-15px] ">
    {/* Gradient border */}
    <div className="absolute inset-0 bg-gradient-to-br from-[#03a9f4] to-white"></div>
    {/* Glow */}
    <div className="absolute inset-0 bg-gradient-to-br from-[#03a9f4] to-red-200 blur-[70px]"></div>
