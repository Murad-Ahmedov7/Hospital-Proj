  ...
  <div className=" flex flex-col xl:flex-row items-center bg-cyan-50 rounded-3xl shadow-xl p-8 lg:p-12 gap-8 lg:gap-12 overflow-hidden">
  ...
  Read a short **overview of the department**, explore the **profiles and availability of our doctors**, and learn about the **services and treatment packages** we provide. 
  Check the **patient preparation guide** to know how to get ready for your visit, and browse the **FAQ & contact information** for quick answers to your questions. 
