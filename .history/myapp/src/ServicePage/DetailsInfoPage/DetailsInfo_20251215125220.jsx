...
<div className="flex flex-col bg-cyan-50 rounded-3xl min-h-screen  shadow-xl p-12 gap-12">

  {/* Hero şəkil */}
  <div className="flex items-center justify-center w-full max-h-[70vh] relative">
    <img
      src="/images/cheerful-medics-team-hospital_23-2147763833.jpg"
      alt="Hero Visual"
      className="w-full h-full rounded-2xl shadow-md object-cover object-center"
    />
    {/* Overlay gradient */}
