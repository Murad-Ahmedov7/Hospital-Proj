...
<div className="relative flex flex-col lg:flex-row items-center bg-cyan-50 rounded-3xl shadow-xl p-8 lg:p-12 gap-8 lg:gap-12 overflow-hidden">
      ...
      <div className="flex-shrink-0 w-full lg:w-[64%] xl:w-[60%] 2xl:-w-[50%]  lg:h-[600px] relative">
        <img
      ...
      <div className="flex flex-col gap-4 lg:gap-6 text-cyan-900 lg:w-1/2 xl:w-[40%] 2xl:w-[50%]">
