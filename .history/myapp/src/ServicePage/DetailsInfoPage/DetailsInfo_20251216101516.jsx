...
<div className="flex gap-[80px] w-[100%] ">
      <div className="flex flex-col gap-4 lg:gap-6 text-cyan-900 w-[30%] max-w-3xl mx-auto">
        <h1 className="text-3xl lg:text-5xl font-extrabold leading-tight text-center">
          Plan your visit with ease
        </h1>
...

  {
    ...
    {/* Card content  */}
     <div className="absolute flex flex-col items-center px-[1200px]  gap-3  transition-transform duration-300 group-hover:scale-130 group-hover:translate-y-[-15px]">
      <d.icon className="group-hover:hidden" size={70} />
      <p className="text-3xl  font-semibold text-center text-white ">
       {d.title}
      </p>
