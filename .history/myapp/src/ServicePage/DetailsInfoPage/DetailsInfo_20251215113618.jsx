...
<div className="relative flex flex-col lg:flex-row items-center bg-cyan-50 rounded-3xl shadow-xl p-8 lg:p-12 gap-8 lg:gap-12 overflow-hidden">
      ...
      <div className="flex-shrink-0 w-full lg:w-1/2  lg:h-[600px] relative">
        <img
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black-400/50 to-transparent rounded-2xl"></div>
      </div>
