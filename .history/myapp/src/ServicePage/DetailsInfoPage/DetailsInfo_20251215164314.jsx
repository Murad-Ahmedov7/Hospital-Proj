...
export default function DetailsInfo() {
  return (
    ...
    <div className="flex flex-col  rounded-3xl shadow-xl px-[300px] items-center py-12 gap-12">
      {/* Hero şəkil */}
      <div className="flex items-center justify-center w-full h-screen relative">
        <img
          ...
          alt="Hero Visual"
          className="w-[100%] h-auto rounded-2xl shadow-md  bg-gradient-to-t object-cover"
        />
        {/* Overlay gradient */}
