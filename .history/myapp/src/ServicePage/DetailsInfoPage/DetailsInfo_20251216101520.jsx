...
<div className="flex gap-[80px] w-[100%] ">
...

  {
    ...
    {/* Card content  */}
     <div className="absolute flex flex-col items-center mx-[1200px]  gap-3  transition-transform duration-300 group-hover:scale-130 group-hover:translate-y-[-15px]">
      <d.icon className="group-hover:hidden" size={70} />
      <p className="text-3xl  font-semibold text-center text-white ">
       {d.title}
      </p>
