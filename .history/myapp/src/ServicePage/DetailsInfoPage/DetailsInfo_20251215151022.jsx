...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
  ...
  {/* Glow / Blur */}
  <div className="absolute inset-0 bg-gradient-to-br from-[#03a9f4] to-white blur-[30px] z-0"></div>
  {/* Dark overlay */}
  <div className="absolute inset-0 bg-black/10 rounded-2xl transition-colors duration-300 group-hover:bg-black/40 z-10"></div>
