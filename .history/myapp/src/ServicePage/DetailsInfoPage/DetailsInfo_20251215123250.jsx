...
<div className="flex flex-col min-h-screen bg-cyan-50 rounded-3xl shadow-xl p-12 gap-12">

  {/* Hero şəkil */}
  <div className="flex items-center justify-center w-full h-[600px] md:h-[700px] lg:h-[820px] relative">
    <img
      src="/images/cheerful-medics-team-hospital_23-2147763833.jpg"
      alt="Hero Visual"
      className="rounded-2xl shadow-md object-contain max-h-full max-w-full"
    />
    {/* Overlay gradient */}
  ...
  {/* Text və CTA */}
  <div className="flex flex-col items-center gap-4 lg:gap-6 text-cyan-900 w-full max-w-3xl">
