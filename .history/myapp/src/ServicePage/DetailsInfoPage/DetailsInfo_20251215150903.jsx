...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
  <div className="relative w-[290px] h-[354px] flex justify-center items-center group rounded-2xl overflow-hidden">
    {/* Gradient border */}
    <div className="absolute inset-0 bg-gradient-to-br from-[#03a9f4] to-white z-0"></div>
    {/* Glow */}
    <div className="absolute inset-0 bg-gradient-to-br from-[#03a9f4] to-white blur-[50px] z-0"></div>
    {/* Dark overlay */}
    <div className="absolute inset-1 bg-black/10 rounded-2xl transition-colors duration-300 group-hover:bg-black/40 z-10"></div>

    {/* Card content */}
    <div className="absolute flex flex-col items-center gap-3  transition-transform duration-300 group-hover:scale-105  z-20">
