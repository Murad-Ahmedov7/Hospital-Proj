...
export default function Service() {
  ...
  return (
    <div id="services" className="flex flex-col justify-center  min-h-screen bg-gradient-to-bl from-blue-300 to-white   ">
      ...
      <div className="grid  grid-cols-3 grid-rows-2  xl:px-40 2xl:px-61  gap-11 justify-start   ">
