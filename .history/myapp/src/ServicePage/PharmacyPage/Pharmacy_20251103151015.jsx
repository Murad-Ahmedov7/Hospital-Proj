...
// )
  ...
  return (
    <div className="w-full max-w-4xl mx-auto mt-10">
      ...
      >
        <SwiperSlide>
          <div className="bg-gradient-to-r from-purple-500 to-pink-500 h-64 flex items-center justify-center text-white text-2xl font-bold">
            Slide 1
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="bg-gradient-to-r from-green-400 to-blue-500 h-64 flex items-center justify-center text-white text-2xl font-bold">
            Slide 2
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="bg-gradient-to-r from-yellow-400 to-red-500 h-64 flex items-center justify-center text-white text-2xl font-bold">
            Slide 3
          </div>
        </SwiperSlide>
      </Swiper>
