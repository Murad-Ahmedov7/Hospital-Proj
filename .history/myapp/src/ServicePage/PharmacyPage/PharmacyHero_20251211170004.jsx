            ...
            <div className="outer-right flex flex-col gap-8 w-[35%]">
              <div className="user-box flex w-full gap-20">
                ...
                <div className="images-box flex ">
                  <img className="absolute ml-2" src="/images/user pics/user1.png" alt="Image not available" />
                  <img className="absolute ml-10" src="/images/user pics/user2.png" alt="Image not available" />
                  <img className="absolute ml-12" src="/images/user pics/user3.png" alt="Image not available" />
                  <img className="absolute ml-16" src="/images/user pics/user4.png" alt="Image not available" />
