            ...
            <div className="outer-right flex flex-col gap-8 w-[35%]">
              <div className="user-box flex w-full gap-4">
                 <div className="flex -space-x-5">
                  ...
                  <img className="w-12 h-12 rounded-full" src="/images/user pics/user2.png" />
                  <img className="w-12 h-12 rounded-full" src="/images/user pics/user3.png" />
                  <img className="w-12 h-12 rounded-full" src="/images/user pics/user4.png" />
                 </div>
