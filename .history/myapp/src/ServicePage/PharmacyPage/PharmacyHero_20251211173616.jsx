  ...
  return (
    <div className="w-full pt-[72px]">
      <div className="flex justify-center items-center relative">
        ...
        <div className=" inner-content flex flex-col   absolute w-[86%] h-[80%] ">

          <div className="row-up flex w-[96%]">
         ...
         <div className="row-down flex w-[97%]">
            <img src="images/banner-img1.jpg" alt="Picture not available" />
            <img src="images/banner-img2.jpg" alt="Picture not available" />
          </div>
