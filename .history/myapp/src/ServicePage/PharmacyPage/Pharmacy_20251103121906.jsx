        ...
        <div
         ...
         className={`flex gap-10  ${styles.animateScroll}`}>
          ...
          {extendedSlides.map((s,i) => (
            <div className="bg-gradient-to-bl from-gray-200/90 to-gray-400/10 px-5 flex-shrink-0 w-85 min-h-1110 rounded-2xl ">

              <div className="flex h-[75%] justify-center items-center">
                <img key={i} src={s.src} alt="Image not available" />
              </div>

              <div className="w-full flex flex-col border-1 border-white rounded-full p-7    items-start ">
