...
export default function PopularCategories({categories}) {
  return (
    <div className="flex flex-col justify-center items-center min-h-[500px] max-h-[1000px]      ">

      <div className="flex flex-col justify-center items-center lg:mt-5 2xl:mt-0  ">
