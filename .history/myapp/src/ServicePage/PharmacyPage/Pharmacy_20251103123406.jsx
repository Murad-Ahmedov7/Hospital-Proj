        ...
        <div
         ...
         className={`flex gap-10  ${styles.animateScroll}`}>
          ...
          {extendedSlides.map((s,i) => (
            <div className="bg-gradient-to-bl from-gray-200/90 to-gray-400/10 px-5  w-100 min-h-140 rounded-xl ">

              <div className="flex h-[72%] justify-center items-center">
                <img key={i} src={s.src} alt="Image not available" />
              </div>

              <div className="w-full flex flex-col border-1 border-white bg-white rounded-xl  p-5 gap-2     items-start ">
