  ...
  return (
    <div className="w-full pt-[72px]">
      <div className="flex justify-center items-center relative">
        ...
        <div className=" inner-content flex   min-w-[1600px] absolute w-[50%] h-[50%] ">
          ...
          <div className="row min-w-[1400px]">
            <div className="outer-left max-w-[600px]">
              ...
              <div className="inner-left min-h-[400px] min-w-[1100px] flex flex-col">
                ...
                <ul className="list-unstyled  flex items-center justify-center border-1 border-cyan-400 bg-cyan-300/30  rounded-2xl gap-4 w-[230px] py-2 ">
