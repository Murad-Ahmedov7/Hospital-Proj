...
export default function Pharmacy() {
  ...
  return (
    <div className="bg-gradient-to-bl from-blue-300 to-gray-100 w-screen h-screen flex overflow-hidden items-center   justify-center ">
      <div className="w-screen h-[20%] relative  top-50  ">
        ...
        {/* Buttons */}
        <div className="absolute inset-0 flex items-center justify-between p-15">
          <button
            onClick={prev}
