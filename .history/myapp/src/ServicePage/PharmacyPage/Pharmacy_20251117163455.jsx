    ...
    <div className="bg-gradient-to-bl w-screen h-screen ">
      ...
      <div className="flex flex-col justify-center items-center h-[70%] gap-7 ">
        ...
        <div className="flex gap-7 ">
          {
            categories.map((c)=>(
              <div className="relative flex justify-center  hover:bg-black/85">
              <img className="w-[100%] rounded-2xl" src={c.src} alt="Image not found"/>
              <div className=" absolute bottom-2  font-oswald font-bold   bg-white h-[15%] border-white w-[92%] flex items-center justify-center rounded-2xl ">
               <p>{c.name}</p>
              </div>
