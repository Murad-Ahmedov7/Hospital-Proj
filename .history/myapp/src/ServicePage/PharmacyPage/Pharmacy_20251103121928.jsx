        ...
        <div
         ...
         className={`flex gap-10  ${styles.animateScroll}`}>
          ...
          {extendedSlides.map((s,i) => (
            <div className="bg-gradient-to-bl from-gray-200/90 to-gray-400/10 px-5 flex-shrink-0 w-85 min-h-110 rounded-2xl ">
              ...
              <div className="flex">
                ...
                <div className="flex">
                <button className="bg-red-400 rounded-2xl p-2">Add to cart</button>
                <p>42 dollar</p>
