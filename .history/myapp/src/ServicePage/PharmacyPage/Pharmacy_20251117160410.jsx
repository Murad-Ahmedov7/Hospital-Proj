...
export default function Pharmacy() {
  ...
  const categories=[
    { id: 1, src: "/images/popular categories/popular-categories1.jpg" },
    { id: 2, src: "/images/popular categories/popular-categories2.jpg" },
    { id: 3, src: "/images/popular categories/popular-categories3.jpg" },
    { id: 4, src: "/images/popular categories/popular-categories4.jpg" },
  ...
  return (
    <div className="bg-gradient-to-bl w-screen h-screen ">
      ...
      <div className="flex flex-col justify-center items-center h-[40%] gap-7 ">
        <p className="text-gray-600 text-2xl font-bold">Top Choices</p>
        <p className="font-bold text-5xl">Our Popular  Categories</p>
        ...
        <div className="flex">
          {
            categories.map((c)=>(
              <div>
              <img className="w-[80% ]" src={c.src} alt="Image not found"/>
              </div>
            ))
          }
        </div>
