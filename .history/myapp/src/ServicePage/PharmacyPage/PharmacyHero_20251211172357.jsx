      ...
      <div className="flex justify-center items-center relative">
        ...
        <div className=" inner-content flex   absolute w-[86%] h-[80%] ">
          ...
          <div className="row-up flex w-[97%]">
            ...
            <div className="outer-right flex flex-col gap-7 w-[35%]">
              ...
              <div className="w-full flex gap-4">
                ...
                <button className=" flex border-dashed border-2 rounded-4xl px-4 py-2 border-white text-white font-bold">     <GrFormUpload size={30} />  Upload Prescription</button>
              </div>
            </div>
