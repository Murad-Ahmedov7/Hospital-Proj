...
export default function PopularCategories({categories}) {
  return (
    <div className="flex flex-col justify-center items-center h-[500px] lg:h-[600px] min-w-screen     ">
      ...
      <div className="flex gap-7 lg:max-w-[1000px]   xl:max-w-[1440px]  2xl:max-w-[1900px] justify-center items-center ">
        {categories.map((c) => (
