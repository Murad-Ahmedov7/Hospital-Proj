  ...
  return (
      <div className=' flex h-screen w-screen justify-center items-center pt-[72px]  '>    {/* main container */}
        ...
        <div className='  w-[71%] bg-red-600'> {/* left content container */}
          ...
          <div className='flex'>
            <p className='text-oswald text-2xl '>Product Details</p>
            <p className='text-oswald text-2xl f>Product Details</p>
            <p className='text-oswald text-2xl font-bold'>Product Details</p>
            <p className='text-oswald text-2xl font-bold'>Product Details</p>
