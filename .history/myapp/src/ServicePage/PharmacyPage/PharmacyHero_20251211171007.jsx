    ...
    <div className="w-full pt-[72px]">
      <div className="flex justify-center items-center relative">
        ...
        <div className=" inner-content flex   absolute w-[86%] h-[80%] ">
          ...
          <img className="w-10 h-10 rounded-full" src="/images/user pics/user1.png" />
          <img className="w-10 h-10 rounded-full" src="/images/user pics/user2.png" />
          <img className="w-10 h-10 rounded-full" src="/images/user pics/user3.png" />
          <img className="w-10 h-10 rounded-full" src="/images/user pics/user4.png" />
        </div>
