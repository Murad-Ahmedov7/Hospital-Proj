    ...
    <div className="bg-gradient-to-bl w-screen h-screen overflow-hidden">
      <div className="flex flex-col justify-center items-center h-full gap-7 overflow-hidden">
        ...
        >
          {slides.map((s, i) => (
            <SwiperSlide key={i}>
              <div className="bg-gradient-to-bl from-gray-200/90 to-gray-400/10 px-5 flex-shrink-0 w-140 min-h-130 rounded-xl shadow-lg group1">
                <div className="flex h-[68%] justify-center items-center pt-6 ">
                  <img
                    src={s.src}
                    alt={`slide-${i}`}
                ...
                <div className="w-full flex flex-col border-1 border-white bg-white rounded-2xl p-5 gap-1 items-start transition-colors group1-hover:bg-green-300  "> 
