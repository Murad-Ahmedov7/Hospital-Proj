...
const extendedSlides = [...slides, ...slides];
  ...
  return (
    <div className="bg-gradient-to-bl from-blue-300 to-gray-100 w-screen h-screen overflow-hidden">
      ...
      <div className="flex flex-col  justify-center items-center h-full gap-7 ove">
        ...
        <div
         ...
         className={`flex gap-10 overflow-hidden ${styles.animateScroll}`}>

          {extendedSlides.map((s,i) => (
            <div className="bg-gradient-to-bl from-gray-200/90 to-gray-400/50 px-5 flex-shrink-0 w-85 min-h-130 ">
