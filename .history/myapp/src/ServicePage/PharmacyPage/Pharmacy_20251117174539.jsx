        ...
        <div className="flex gap-7 ">
          {
            categories.map((c)=>(
              ...
              <Link to={} className="absolute inset-0 bg-black/50   rounded-2xl flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-1200 cursor-pointer">
