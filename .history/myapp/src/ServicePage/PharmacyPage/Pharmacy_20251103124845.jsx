         ...
         className={`flex gap-10  ${styles.animateScroll}`}>
          ...
          {extendedSlides.map((s,i) => (
            <div className="bg-gradient-to-bl from-gray-200/90 to-gray-400/10 px-5 flex-shrink-0 w-100 min-h-130 rounded-xl ">
              ...
              <div className="w-full flex flex-col border-1 border-white bg-white rounded-xl  p-5 gap-1   items-start hover:bg-[#5c45bf]  ">
              ...
              <div className="flex justify-between w-full  ">
                ...
                <div className="flex justify-between w-full pt-3 items-center  hover:text-white ">
