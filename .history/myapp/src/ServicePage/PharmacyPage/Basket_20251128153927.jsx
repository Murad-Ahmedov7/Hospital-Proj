  ...
  return (
      <div className=' flex h-screen w-screen justify-center items-center pt-[72px]  '>    {/* main container */}
        ...
        <div className='  w-[71%] bg-red-600'> {/* left content container */}
          ...
          <div className='flex'>
            <p className='text-oswald text-2xl w-[150px] '>Product Details</p>
            <p className='text-oswald text-2xl w-[100px] '>Price</p>
            <p className='text-oswald text-2xl [30%] '>Quantity</p>
            <p className='text-oswald text-2xl [10%] '>Total</p>
