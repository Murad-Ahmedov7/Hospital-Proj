        ...
        <div
         ...
         className={`flex gap-10  ${styles.animateScroll}`}>
          ...
          {extendedSlides.map((s,i) => (
            <div className="bg-gradient-to-bl from-gray-200/90 to-gray-400/10 px-5 flex-shrink-0 w-100 min-h-130 rounded-xl ">

              <div className="flex h-[69%] justify-center items-center">
                <img key={i} src={s.src} alt="Image not available" />
              </div>

              <div className="w-full flex flex-col border-1 border-white bg-white rounded-xl  p-5 gap-1   items-start ">
              ...
              <div className="flex justify-between w-full">
                ...
                <button className="border-2 rounded-2xl px-4 py-3 font-semibold">Add to cart</button>
                <p>42 dollar</p>
