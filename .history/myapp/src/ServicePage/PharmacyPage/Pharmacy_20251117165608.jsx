...
export default function Pharmacy() {
  ...
  return (
    <div className="bg-gradient-to-bl w-screen h-screen ">


      <div className="flex flex-col justify-center items-center h-[70%] gap-7 ">
        <p className="text-gray-600 text-2xl font-bold">Top Choices</p>
        <p className="font-bold text-5xl font-oswald">Our Popular  Categories</p>
        ...
        <div className="flex gap-7 ">
          {
            categories.map((c)=>(
              ...
              <img className="w-[100%] rounded-2xl  " src={c.src} alt="Image not found"/>
              
              
              <div className="absolute inset-0 bg-black/40   rounded-2xl flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-600">
              <p>icon</p>
              </div>

              <div className=" absolute bottom-2  font-oswald font-bold  group-hover:bg-black/85 hover:text-white transition-all duration-400 ease-in  bg-white h-[15%] border-white w-[92%] flex items-center justify-center rounded-2xl ">
      ...
      <div className="flex flex-col justify-center items-center h-full gap-7 ">
        ...
        >
          {slides.map((s, i) => (
            <SwiperSlide key={i}>
              <div className="bg-gradient-to-bl from-gray-200/90 to-gray-400/10 px-5 flex-shrink-0 w-140 min-h-130 rounded-xl shadow-lg group">
                <div className="flex h-[68%] justify-center items-center pt-6 ">
                  <img
                    src={s.src}
                    alt={`slide-${i}`}
      ...
      <div className="flex flex-col justify-center items-center h-[20%] gap-7 ">
        <p className="text-gray-600 text-2xl font-bold">Best Items  </p>
