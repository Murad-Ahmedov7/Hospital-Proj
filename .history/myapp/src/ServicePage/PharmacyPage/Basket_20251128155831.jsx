      ...
      <div className=' flex min-h-screen w-screen justify-center items-center pt-[72px]  '>    {/* main container */}
        ...
        <div className='  w-[71%]'> {/* left content container */}
          ...
          <div className='flex gap-10 mt-4'>
            ...
            <p className='text-oswald text-[15px] text-[#4e4e4e] font-bold w-[22%]  '>Price</p>
            <p className='text-oswald text-[15px] text-[#4e4e4e] font-bold w-[22%]  '>Quantity</p>
            <p className='text-oswald text-[15px] text-[#4e4e4e] font-bold w-[22%]  '>Total</p>
