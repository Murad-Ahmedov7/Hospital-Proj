...
export default function PharmacyShop() {
  ...
  return (
    <div className="w-screen h-screen flex items-center overflow-x-hidden ">
      <div className="h-[70%]  w-[17%] flex flex-col  gap-4 ">
        ...
        <div className="flex flex-col gap-7">
          ...
          <div className="flex flex-col gap-4 items-center">
            ...
            <p className="font-oswald font-bold text-2xl mr-12">Categories: </p>
            {[...Array(5)].map((_, i) => (
              <div className="flex ">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" className="hidden peer" />

                  <div className="w-14 h-4 rounded-full border border-gray-500 peer-checked:bg-green-600"></div>
            ...
            <div className="border h-0 opacity-10 w-10"></div>
