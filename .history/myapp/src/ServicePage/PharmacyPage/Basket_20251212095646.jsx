...
const decreaseCount=()=>{
  ...
  return (
    <div className=" flex  flex-col gap-14 min-h-screen w-screen justify-center items-center pt-[72px]  ">


      {/* <div className="flex w-screen px-11   relative">
      <img className="rounded-4xl w-full h-[500px]" src="/images/cyan-bg.png"/>


        <div className=" flex  flex-col gap-7   w-[90%] h-full items-center justify-center  absolute ">
  ...
  <img
    className="rounded-4xl w-full h-[350px] md:h-[450px] lg:h-[500px] object-cover"
    src="/images/cyan-bg.png"
  />

  <div className="absolute inset-0 flex flex-col items-center justify-center gap-6 px-4">
    
    <p className="text-white font-bold text-4xl md:text-6xl xl:text-7xl 2xl:text-8xl">
      Shopping Cart
    </p>

    <p className="text-white text-base md:text-xl lg:text-2xl text-center max-w-2xl">
      Almost there! Review your items and get ready for fast, safe delivery right to your door.
    </p>

    <ul className="flex items-center justify-center border border-cyan-400 bg-cyan-300/30 rounded-2xl gap-4 px-4 py-2">
      <li className="flex items-center gap-1 text-white font-oswald font-bold">
        <BsCircleFill color="white" size={6} /> Home
      </li>
      <li className="flex items-center gap-1 text-white font-oswald font-bold">
        <BsCircleFill color="white" size={6} /> Cart
      </li>
    </ul>
