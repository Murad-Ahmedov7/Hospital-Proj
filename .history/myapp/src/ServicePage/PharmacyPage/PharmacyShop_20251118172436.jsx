...
export default function PharmacyShop() {
  ...
  return (
    <div className="w-screen h-screen flex items-center overflow-x-hidden ">
      ...
      <div className="h-[70%]  w-[25%] flex flex-col  gap-10 items-end mr-4 "> 
      ...
      <p className="text-2xl font-oswald  font-bold w-full text-center pl-15 ">Filter by Price</p>
        <Slider.Root
          className="relative flex items-center w-[62%] h-4"
          value={value}
        ...
        >
          ...
          <div className="flex gap-4 justify-start  w-[62%]">
          <p className="">Range:</p>
          <p className="text-cyan-500 text-2xl font-bold">{`${value[0]}$`}</p>
          <p className="text-cyan-500 font-bold">{`${value[1]}$`}</p>
