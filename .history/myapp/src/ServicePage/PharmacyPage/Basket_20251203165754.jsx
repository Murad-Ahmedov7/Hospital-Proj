        ...
        <div className=" flex h-[700px] w-full gap-10 justify-center  ">
          ...
          <div className="  lg:w-[70%] xl:w-[50%] flex flex-col gap-8  ">
            ...
            <div className="flex justify-between ">
              ...
              <p className="text-oswald text-xl font-bold">(    {`${itemsCount}items`} )</p>
            </div>
...
{/* 
          ...
          <div className="  bg-[rgb(250,247,207)]   h-[500px] w-[25%] rounded-[30px] flex flex-col gap-4">
            ...
            <div className="flex  justify-center items-center h-[70px] w-full">
              ...
              <p className="px-8 font-oswald font-bold font-[20px]">Product Details:</p>
             ...
             <div className=" flex justify-between items-end pt-auto h-[60px] px-8">  
                <p>Grand Total</p>
                <p>$800.00</p>
              </div>
