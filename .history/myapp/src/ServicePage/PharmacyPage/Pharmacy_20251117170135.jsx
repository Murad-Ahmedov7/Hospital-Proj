        ...
        <div className="flex gap-7 ">
          {
            categories.map((c)=>(
              ...
              <div className="absolute inset-0 bg-black/40   rounded-2xl flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-600 cursor-pointer">
             <BsArrowRightCircle />
              </div>
