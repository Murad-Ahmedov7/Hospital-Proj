          ...
          <div className="row w-[700px]">
            <div className="outer-left max-w-[600px]">
              ...
              <div className="inner-left min-h-[400px]">
                ...
                <ul className="list-unstyled  flex items-center justify-center border-1 border-cyan-400 bg-cyan-400/20 background-blur-2xl rounded-2xl gap-4 w-[230px] py-1 ">
