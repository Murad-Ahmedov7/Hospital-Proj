...
export default function Pharmacy() {
  ...
  const categories=[
    ...
    { id: 3, src: "/images/popular categories/popular-category3.jpg" },
    { id: 4, src: "/images/popular categories/popular-category4.jpg" },
  ...
  return (
    <div className="bg-gradient-to-bl w-screen h-screen ">
      ...
      <div className="flex flex-col justify-center items-center h-[6 0%] gap-7 ">
        <p className="text-gray-600 text-2xl font-bold">Top Choices</p>
