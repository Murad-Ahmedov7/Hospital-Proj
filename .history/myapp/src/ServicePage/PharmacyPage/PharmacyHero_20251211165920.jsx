            ...
            <div className="outer-right flex flex-col gap-8 w-[35%]">
              <div className="user-box flex w-full gap-20">
                ...
                <div className="images-box flex ">
                  ...
                  <img className="absolute ml-14" src="/images/user pics/user3.png" alt="Image not available" />
                  <img className="absolute ml-18" src="/images/user pics/user4.png" alt="Image not available" />
