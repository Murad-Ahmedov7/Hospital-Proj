...
export default function PharmacyShop() {
  ...
  return (
    <div className="w-screen h-screen flex items-center overflow-x-hidden ">
      ...
      <div className="h-[70%]  w-[25%] flex flex-col  gap-10 "> 
        ...
        <div className="flex flex-col gap-7  items-center">
          ...
          <div className="border h-0 opacity-10 w-70 ml-20"></div>
      ...
      <div className="flex flex-col  w-full items-end">
        ...
        <Slider.Root
          className="relative flex items-center w-[80%] h-4"
          value={value}
          onValueChange={handleValueChange}
          step={5}
          aria-label="Price range"
        >
          <Slider.Track className="bg-gray-300 relative w-[90%] rounded-full h-1">
