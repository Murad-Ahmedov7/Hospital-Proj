      ...
      <div className=' flex min-h-screen w-screen justify-center items-center pt-[72px]  '>    {/* main container */}
        ...
        <div className='  w-[71%]'> {/* left content container */}
          ...
          <div className='flex gap-10 mt-4'>
            <p className='text-oswald text-[15px] text-[#4e4e4e] font-bold min-w-[200px] '>Product Details</p>
            <p className='text-oswald text-[15px] text-[#4e4e4e] font-bold w-[150px]  '>Price</p>
            <p className='text-oswald text-[15px] text-[#4e4e4e] font-bold w-[150px]  '>Quantity</p>
            <p className='text-oswald text-[15px] text-[#4e4e4e] font-bold w-[150px]  '>Total</p>
