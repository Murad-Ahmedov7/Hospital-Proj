          ...
          <div className="  w-[50%] flex flex-col gap-6  ">
            ...
            <div className="w-[800px] h-[400px] ">
              ...
              <div className="flex w-full ">
                ...
                <div className="bg-[#f1f5f9] w-[93px] h-[93px] flex items-center justify-center  rounded-2xl ">
                  <img className="w-[59px] h-[56px]" src="/images/popular products/product3.png " alt="image not found" />
                </div>
              </div>
