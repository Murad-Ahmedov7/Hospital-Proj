...
const decreaseCount=()=>{
  ...
  return (
    <div className=" flex  flex-col gap-14 min-h-screen w-screen justify-center items-center pt-[72px]  ">
      ...
      <div className=" flex  flex-col gap-7 w-full h-[90%] items-center justify-center  absolute ">
        <p className="text-white font-bold lg:text-6xl xl:textext-8xl">Shopping Cart </p>
