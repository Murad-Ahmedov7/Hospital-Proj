...
const decreaseCount=()=>{
  ...
  return (
    <div className=" flex  flex-col gap-14 min-h-screen w-screen justify-center items-center pt-[72px]  ">
      ...
      <img className="rounded-4xl w-full h-[400px]" src="/images/cyan-bg.png"/>
      <div className=" flex  flex-col gap-3 w-full h-full items-center justify-center overflow-hidden absolute ">
        ...
        <p className="text-white text-[22px] w-[700px] text-center">Almost there! Review your items and get ready for fast, safe delivery  right to your door. </p>
                        ...
                        <ul className="list-unstyled  flex items-center justify-center border-1 border-cyan-400 bg-cyan-300/30  rounded-2xl gap-4 w-[240px] py-1.5 ">
