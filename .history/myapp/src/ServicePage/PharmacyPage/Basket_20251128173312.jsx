        ...
        <div className=" flex h-[700px] w-full gap-10 justify-center  ">
          ...
          <div className="  w-[50%] flex flex-col gap-8  ">
            ...
            <div className="w-[800px] h-[400px] ">
              ...
              <div className="flex w-full gap-3  "> {/*bir row*/}


                <div className="flex gap-5 w-[37%]">   {/*sekil ve aciqlamalari*/} 
                ...
                <div className="flex flex-col ">
                  ...
                  <p className="w-[15%] text-oswald text-xl text-[#4e4e4e] font-bold text-center   ">48.00$</p>
               

          
                  <p className="w-[15%] text-oswald text-xl text-[#4e4e4e] font-bold text-center">48.00$</p>
           
                  <p className=" w-[15%] text-oswald text-xl text-[#4e4e4e] font-bold text-cente" >144.00</p>


                  <IoMdCloseCircleOutline className="" size={50} color="red" />
