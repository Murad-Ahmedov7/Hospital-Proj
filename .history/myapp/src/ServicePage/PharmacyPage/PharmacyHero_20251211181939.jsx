      ...
      <div className="flex justify-center items-center relative">
        ...
        <div className=" inner-content flex flex-col gap-[80px]    absolute w-[77%] h-[80%] ">
         ...
         <div className="row-down flex w-[97%] gap-5">
            <img className="rounded-2xl w-[65%] " src="/images/banner-img1.jpg" alt="Picture not available" />
            <img className="rounded-2xl w-[35%]  " src="/images/banner-img2.jpg" alt="Picture not available" />
          </div>
