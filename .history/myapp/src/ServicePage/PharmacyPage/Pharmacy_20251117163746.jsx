        ...
        <div className="flex gap-7 ">
          {
            categories.map((c)=>(
              ...
              <div className=" absolute bottom-2  font-oswald font-bold  hover:bg-black/85 hover:text-white transition-all duration-700 ease-in    bg-white h-[15%] border-white w-[92%] flex items-center justify-center rounded-2xl ">
