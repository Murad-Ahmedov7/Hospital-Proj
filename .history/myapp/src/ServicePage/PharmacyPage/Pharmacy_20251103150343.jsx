...
return(
  ...
  className="w-[90%] py-10"
        ...
        >
            {slides.map((s,i) => (
        <SwiperSlide key={i}>
  <div className="bg-gradient-to-bl from-gray-200/90 to-gray-400/10 px-5 w-full md:w-[300px] lg:w-[320px] min-h-[400px] rounded-xl flex-shrink-0">
    <div className="flex h-[68%] justify-center items-center">
      <img src={s.src} alt="Image not available" className="h-full object-contain" />
    </div>

    <div className="w-full flex flex-col border border-white bg-white rounded-2xl p-5 gap-1 items-start hover:bg-[#5c45bf]">
      <div className="flex justify-between w-full">
        <p>Supplement</p>
        <p>⭐4.8/5</p>
      </div>
