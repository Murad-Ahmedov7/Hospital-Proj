...
return(
  ...
  <div className="flex flex-col justify-center items-center h-full gap-7 overflow-hidden">
    ...
    <Swiper
      ...
      breakpoints={{
        320: { slidesPerView: 1, spaceBetween: 20 }, // Mobil üçün 1 slide
        768: { slidesPerView: 2, spaceBetween: 30 }, // Tablet üçün 2 slide
        1024: { slidesPerView: 3, spaceBetween: 40 }, // Desktop üçün 3 slide
      }}
    >
      {slides.map((s, i) => (
        <SwiperSlide key={i} className="flex justify-center">
          <div className="bg-gradient-to-bl from-gray-200/90 to-gray-400/10 px-5 w-[440px] min-h-[130px] rounded-xl">
            <div className="flex h-[68%] justify-center items-center">
              <img src={s.src} alt="Image not available" className="max-h-full object-contain" />
            </div>

            <div className="w-full flex flex-col border border-white bg-white rounded-2xl p-5 gap-1 items-start hover:bg-[#5c45bf] hover:text-white">
              <div className="flex justify-between w-full">
                <p>Supplement</p>
                <p>⭐4.8/5</p>
              </div>
