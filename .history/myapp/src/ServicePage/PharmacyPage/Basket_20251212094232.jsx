...
const decreaseCount=()=>{
  ...
  return (
    <div className=" flex  flex-col gap-14 min-h-screen w-screen justify-center items-center pt-[72px]  ">
      ...
      <img className="rounded-4xl w-full h-[600px]" src="/images/cyan-bg.png"/>
      <div className=" flex  flex-col gap-7 w-full h-full items-center justify-center overflow-hidden absolute ">
        <p className="text-white font-bold text-8xl">Shopping Cart </p>
