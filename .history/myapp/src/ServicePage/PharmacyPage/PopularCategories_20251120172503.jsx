...
export default function PopularCategories({categories}) {
  return (
    <div className="flex flex-col justify-center items-center h-[70%] gap-7 lg:pt-25  ">
      <p className="text-gray-600 text-[clamp(0.75rem,_0.25rem_+_0.7813vw,_1.5rem)] font-bold">Top Choices</p>
      <p  className="font-bold text-[clamp(1rem,_-0.3333rem_+_2.0833vw,_3rem)] font-oswald">Our Popular Categories</p> 
