...
export default function Pharmacy() {
  ...
  return (
    <div className="bg-gradient-to-bl from-blue-300 to-gray-100 w-screen h-screen items-center justify-center gap-14">
      <div className="w-[40%] h-[20%] relative  top-50 flex  ">
        <div
