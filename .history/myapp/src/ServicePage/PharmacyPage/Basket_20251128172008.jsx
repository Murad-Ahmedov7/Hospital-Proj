            ...
            <div className="w-[800px] h-[400px] ">
              ...
              <div className="flex w-full gap-11 "> {/*bir row*/}
                ...
                <div className="flex flex-col ">
                  ...
                  <p className="w-[22%] text-oswald text-xl text-[#4e4e4e] font-bold">48.00$</p>
               

          
                  <p className="w-[22%]">48.00$</p>
           

                       <p className="w-[22%] text-oswald text-xl text-[#4e4e4e] font-bold">144.00</p>
