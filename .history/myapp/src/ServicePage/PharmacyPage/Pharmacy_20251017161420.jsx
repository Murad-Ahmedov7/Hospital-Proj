...
export default function Pharmacy() {
  ...
  return (
    <div className="max-w-3xl  relative flex overflow-hidden top-22">
      ...
      <div className="flex absolute items-center justify-between w-full top-3/6 px-2">
        <button>
          <ChevronLeft size={40} className=" border-2 rounded-3xl border-white"  />
        </button>
        <button>
          <ChevronRight size={40} className=" border-2 rounded-3xl" />
        </button>
      </div>
    </div>
  );
