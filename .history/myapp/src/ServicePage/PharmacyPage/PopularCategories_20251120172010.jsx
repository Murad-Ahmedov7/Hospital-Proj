...
export default function PopularCategories({categories}) {
  return (
    <div className="flex flex-col justify-center items-center h-[70%] gap-7 lg:pt-25  ">
      ...
      <p  className="font-bold text-[clamp(1rem,calc(0.6053rem+1.5789vw),2.5rem)] font-oswald">Our Popular Categories</p> font-size: clamp(1rem, -0.3333rem + 2.0833vw, 3rem);
