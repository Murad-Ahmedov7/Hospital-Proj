...
export default function PopularCategories({categories}) {
  return (
    <div className="flex flex-col justify-center items-center h-[70%] gap-7  ">
      <p className="text-gray-600 text-[clamp(1rem,calc(0.6053rem+1.5789vw),2.5rem)] font-bold">Top Choices</p>
      <p className="font-bold text-[clamp(1rem,calc(0.6053rem+1.5789vw),2.5rem)] font-oswald">Our Popular Categories</p>
