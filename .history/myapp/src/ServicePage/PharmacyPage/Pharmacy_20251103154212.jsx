...
const [slides, setSlides] = useState([
  ...
  return (
    <div className="w-screen h-screen bg-gradient-to-bl from-purple-100 to-indigo-200 flex flex-col items-center justify-center gap-7 p-5 overflow-hidden">
      <p className="text-gray-600 text-2xl font-bold">Top Choices</p>
      <p className="text-5xl font-extrabold text-gray-800">Our Most-liked Products</p>
      ...
      >
        {slides.map((s, i) => (
          <SwiperSlide key={i} className="flex justify-center">
            <div className="bg-white rounded-2xl shadow-lg w-[300px] sm:w-[380px] md:w-[440px] overflow-hidden transition-transform duration-300 hover:scale-105">
              {/* Image */}
              <div className="h-[250px] flex justify-center items-center bg-gray-100">
                <img src={s.src} alt={s.name} className="max-h-full object-contain" />
              </div>

              {/* Content */}
              <div className="p-5 flex flex-col gap-2 hover:bg-purple-600 hover:text-white transition-colors duration-300">
                ...
                <div className="flex justify-between items-center mt-3">
                  <button className="border-2 border-purple-600 text-purple-600 font-semibold px-4 py-2 rounded-2xl hover:bg-white hover:text-purple-600 transition-colors duration-300">
                    Add to cart
                  </button>
