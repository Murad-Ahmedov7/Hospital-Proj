  ...
  return (
      <div className=' flex min-h-screen w-screen justify-center items-center pt-[72px]  '>    {/* main container */}
        ...
        <div className='  w-[71%]'> {/* left content container */}
          ...
          <div className='flex'>
            <p className='text-oswald text-[15px] w-[200px] '>Product Details</p>
            <p className='text-oswald text-[15px] w-[190px]  '>Price</p>
            <p className='text-oswald text-xl w-[150px]  '>Quantity</p>
            <p className='text-oswald text-xl w-[150px]  '>Total</p>
