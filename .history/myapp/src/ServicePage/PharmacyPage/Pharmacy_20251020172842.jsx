...
export default function Pharmacy() {
  ...
  return (
    <div className="bg-gradient-to-bl from-blue-300 to-gray-100 w-screen h-screen flex   justify-center">
      <div className="w-[50%] h-[20%] relative  top-50 ">
        <div
          className="flex transition-transform duration-500 ease-out "
          style={{ transform: (curr === 0 || curr === 2 || curr === 3) ? `translateX(-${curr * 50}%)` : undefined }}
        >
          {slides.map((s, index) => (
            <img
              key={index}
        ...
        <div className="absolute inset-0 flex items-center justify-between p-4">
          ...
          >
            <ChevronRight size={40} />
                ...
                <div className="absolute   top-[50%] bottom-0 left-0 right-0  -translate-1/2   ">
