        ...
        <div className=" inner-content flex justify-center  absolute w-[50%] h-[50%] ">
          ...
          <div className="row w-[700px]">
            <div className="outer-left max-w-[600px]">
              ...
              <div className="inner-left min-h-[400px] min-w-[500px] flex flex-col">
                ...
                <p className="text-8xl w-[400px] text-white font-oswald  font-bold">Instant Pharmacy </p>
                
                <p className="text-8xl text-white font-oswald  font-bold">Access For You </p>
