...
export default function Pharmacy() {
  ...
  return (
    <div className="bg-gradient-to-bl from-[#3AA6B9] to-gray-100 w-screen h-screen items-center justify-center">
      <div className="w-[40%] h-[20%] relative  top-50 flex gap-14 ">
        <div
