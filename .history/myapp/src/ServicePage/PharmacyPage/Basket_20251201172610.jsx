...
{/* 
          ...
          <div className=" bg-[rgb(250,247,207)]   h-[500px] w-[25%] rounded-[30px]">
            ...
            <div className="flex justify-center items-center h-[70px] w-full">
              ...
              <div className="flex ">
                {/* <div className="border h-0 px-[50px]  border-black/10"></div> */}
                <div>Apply Coupons</div>
                <button className="bg-purple-400 rounded-2xl w-[68px] h-[40px]">Apply</button>
              </div>
