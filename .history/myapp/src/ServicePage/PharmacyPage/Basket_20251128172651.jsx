        ...
        <div className=" flex h-[700px] w-full gap-10 justify-center  ">
          ...
          <div className="  w-[50%] flex flex-col gap-8  ">
            ...
            <div className="w-[800px] h-[400px] ">
              ...
              <div className="flex w-full gap-11  "> {/*bir row*/}
                ...
                <div className="flex flex-col ">
                  ...
                  <p className="w-[21%] text-oswald text-xl text-[#4e4e4e] font-bold">48.00$</p>
              ...
              <div className="border h-0  border-black/10 w-screen"></div>
