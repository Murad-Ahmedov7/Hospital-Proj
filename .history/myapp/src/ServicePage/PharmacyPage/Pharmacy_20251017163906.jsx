  ...
  return (
    <div className="max-w-3xl  relative flex overflow-hidden top-22">
      ...
      <div className="flex absolute items-center justify-between w-full top-[50%] px-7">
        <button onClick={()=>prev} className=" bg-white/80 shadow rounded-full  text-gray-800 hover:bg-white">
          <ChevronLeft
            size={40}
          />
        </button>
        <button onClick={()=>next} className=" bg-white/80 shadow rounded-full  text-gray-800 hover:bg-white">
          <ChevronRight
            size={40}
