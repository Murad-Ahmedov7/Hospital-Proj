  ...
  return (
    <div className="bg-gradient-to-bl from-blue-300 to-gray-100 w-screen h-screen items-center justify-center">
      <div className="w-[100%] h-[20%] relative  top-50   ">
        ...
        {/* Buttons */}
        <div className="absolute-translate-x-1/2 -translate-y-1/2flex items-center justify-between p-4">
          <button
            onClick={prev}
          ...
          >
            <ChevronRight size={40} />
              ...
              <div className="absolute  top-[50%] bottom-[50%] -translate-x-1/2 -translate-y-1/2   ">
