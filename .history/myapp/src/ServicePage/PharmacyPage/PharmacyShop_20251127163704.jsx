...
export default function PharmacyShop() {
  ...
  return (
    <div className="w-screen h-screen flex items-center overflow-x-hidden ">
      ...
      <div className="h-[70%] lg:w-[35%] xl:w-[25%] flex flex-col  gap-10 items-end mr-5 "> 
      ...
      <p className="text-2xl font-oswald  font-bold w-[76%] text-start pl-15 ">Filter by Price</p>
        ...
        {/* all cards */}
      <div className="w-[80%]  mt-[810px] grid xl:grid-cols-3 xl:grid-rows-3 lg:grid-cols-2  gap-5 p-4">    
                {slides2.map((s) => (
          <Card s={s} />
        ))}
      </div>
