  ...
  return (
    <div className="bg-gradient-to-bl from-blue-300 to-gray-100 w-screen h-screen overflow-hidden">
      <div className="flex flex-col  justify-center items-center h-full gap-7">
        ...
        >
          {slides.map((s, index) => (
            <div className="bg-gradient-to-bl from-gray-200/90 to-gray-400/50 px-5 w-70 h-100  items-center justify-center">
              <img
                key={index}
                src={s}
                alt="Image not available"
              />
              <div className="w-full flex h-20 items-center jus">
                <p>Supplement</p>
                <p>4.8/5</p>  
              </div>  
            </div>
