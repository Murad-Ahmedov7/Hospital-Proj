...
<div className="bg-gradient-to-bl w-screen h-screen overflow-hidden flex flex-col items-center justify-center gap-7">
  <p className="text-gray-600 text-2xl font-bold">Top Choices</p>
  <p className="font-bold text-5xl">Our Most-liked Products</p>
  ...
  <Swiper
    ...
    autoplay={{ delay: 2500 }}
    spaceBetween={30}
    slidesPerView={3} // desktop üçün 3 slide
    breakpoints={{
      320: { slidesPerView: 1, spaceBetween: 20 }, // mobil
  ...
  >
    {slides.map((s, i) => (
      <SwiperSlide key={i} className="flex justify-center">
        <div className="bg-gradient-to-bl from-gray-200/90 to-gray-400/10 px-5 w-[300px] sm:w-[380px] md:w-[440px] min-h-[300px] rounded-xl">
          <div className="flex h-[68%] justify-center items-center">
            <img src={s.src} alt="Image not available" className="max-h-full object-contain" />
          </div>

          <div className="w-full flex flex-col border border-white bg-white rounded-2xl p-5 gap-1 items-start hover:bg-[#5c45bf] hover:text-white transition-colors duration-300">
            <div className="flex justify-between w-full">
              <p>Supplement</p>
              <p>⭐4.8/5</p>
            </div>
