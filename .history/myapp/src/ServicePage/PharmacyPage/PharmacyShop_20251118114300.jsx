  ...
  return (
    <div className="w-screen h-screen flex items-center overflow-x-hidden ">
      <div className="h-[70%] bg-red-800 w-[17%]">
        <p>Categories</p>
        <Slider.Root className="relative flex items-center w-80 h-4 bg-gray-100 rounded-full p-1 overflow-hidden">
       <Slider.Track className="bg-gray-300 absolute grow rounded-full h-1">
       </Slider.Track>
        </Slider.Root>
      </div>
