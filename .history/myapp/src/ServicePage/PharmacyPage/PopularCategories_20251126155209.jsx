...
export default function PopularCategories({categories}) {
  return (
    <div className="flex flex-col justify-center items-center h-[500px] lg:h-[600px] w-[1300px]     ">
      ...
      <div className="flex gap-7 lg:max-w-[1000px]   xl:max-w-[1040px]  2xl:max-w-[1900px] ">
        {categories.map((c) => (
