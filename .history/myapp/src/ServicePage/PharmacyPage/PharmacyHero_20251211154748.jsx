        ...
        <div className=" inner-content flex justify-center  absolute w-[50%] h-[50%] ">
          ...
          <div className="row w-[700px]">
            <div className="outer-left max-w-[600px]">
              ...
              <div className="inner-left min-h-[400px] flex flex-col gap-4">
                ...
                <p className="text-2xl text-white font-oswald  font-bold">Instant Pharmacy </p>
                <p className="text-2xl text-white font-oswald  font-bold">Access For You </p>
