...
export default function Pharmacy() {
  ...
  const categories=[
    ...
    { id: 1, src: "/images/popular categories/popular-categories2.jpg" },
    { id: 1, src: "/images/popular categories/popular-categories3.jpg" },
    { id: 1, src: "/images/popular categories/popular-categories4.jpg" },
        ...
        <div className="flex">
          {
            categories.map((c)=>(
              <div>
              <img src={c.src} alt="Image not found"/>
              </div>
            ))
          }
        </div>
