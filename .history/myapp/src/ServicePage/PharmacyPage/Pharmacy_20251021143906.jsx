...
const [slides, setSlides] = useState([
  { id: 1, src: "/images/popular products/product1.png", title: "Product 1" },
  { id: 2, src: "/images/popular products/product2.png", title: "Product 2" },
  { id: 3, src: "/images/popular products/product3.png", title: "Product 3" },
  { id: 4, src: "/images/popular products/product4.png", title: "Product 4" },
]);
  ...
  return (
    <div className="bg-gradient-to-bl from-blue-300 to-gray-100 w-screen h-screen overflow-hidden">
      ...
      <div className="flex flex-col  justify-center items-center h-full gap-7">
        ...
        >
          {slides.map((s, index) => (
            <div className="bg-gradient-to-bl from-gray-200/90 to-gray-400/50 px-5 w-70 min-h-130 ">

              <div className="flex h-[75%] justify-center items-center">
                <img key={index} src={s} alt="Image not available" />
              </div>

              <div className="w-full flex border-1 border-white rounded-full p-4   items-center justify-between">
                <p>Supplement</p>
                <p>4.8/5</p>
              </div>
