  ...
  return (
    <div className="w-full pt-[72px]">
      <div className="flex justify-center items-center relative">
        <img className="rounded-4xl w-[90%] min-h-[1040px]" src="/images/cyan-bg.png"/>
        <div className=" inner-content flex flex-col gap-[80px]    absolute w-[77%] h-[80%] ">
          ...
          <div className="row-up flex w-[97%]">
            <div className="outer-left w-[65%]">
              ...
              <div className="inner-left   w-[95%] flex flex-col">
                ...
                <p className="lg:text-7xl  xl:text-7xl 2xl:text-8xl max-w-[987px] h-[4  00px] mt-7 text-white font-oswald  font-bold">Instant Pharmacy Access For You </p>
         ...
         <div className="row-down flex w-[97%] gap-5">
            <img className="rounded-2xl w-[65%] h-[478px]" src="/images/banner-img1.jpg" alt="Picture not available" />
            <img className="rounded-2xl w-[35%] h-[478px]" src="/images/banner-img2.jpg" alt="Picture not available" />
          </div>
