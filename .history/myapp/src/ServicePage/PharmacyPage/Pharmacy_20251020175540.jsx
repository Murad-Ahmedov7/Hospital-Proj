...
export default function Pharmacy() {
  ...
  return (
    <div className="bg-gradient-to-bl from-blue-300 to-gray-100 w-screen h-screen flex   justify-center overflow-hidden">
      <div className="min-w-screen h-[20%] relative  top-50 ">
        <div
          className="flex transition-transform duration-500 ease-out gap-4 w-f"
