    ...
    <div className="w-full mt-10">
      <OwlCarousel className="owl-theme" {...options}>
        {slides.map((s, i) => (
          <div
            key={s.id}
            className="bg-white rounded-xl shadow-md flex flex-col items-center gap-3 p-5"
          >
            <div className="flex h-[72%] justify-center items-center">
              <img src={s.src} alt={`product-${s.id}`} className="h-48 object-contain" />
            </div>

            <div className="w-full flex flex-col border border-gray-200 bg-white rounded-xl p-5 gap-2 items-start">
              <div className="flex justify-between w-full">
                <p>Supplement</p>
                <p>⭐4.8/5</p>
              </div>
              ...
              <div className="flex justify-between w-full items-center">
                <button className="bg-red-400 text-white rounded-2xl p-2 hover:bg-red-500 transition">
                  Add to cart
                </button>
                <p>42 dollar</p>
              </div>
