          ...
          <div className="row w-[700px]">
            <div className="outer-left max-w-[600px]">
              ...
              <div className="inner-left min-h-[400px]">
                ...
                <ul className="list-unstyled  flex items-center justify-center border-1 border-cyan-400 bg-cyan-300/50  rounded-2xl gap-4 w-[230px] py-1 ">

                  <li className="flex items-center gap-1 text-gray-300 font-oswald font-bold">
                    <BsCircleFill color="white" size={6} />
                    Health
                  </li>
                  <li className="flex items-center gap-1 text-gray font-oswald  font-bold">
                    <BsCircleFill color="white" size={6} />
                    Truth
                  </li>
