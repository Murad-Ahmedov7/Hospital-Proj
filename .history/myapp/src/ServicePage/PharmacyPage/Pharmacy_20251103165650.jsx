          ...
          {slides.map((s, i) => (
            <SwiperSlide key={i}>
              <div className="bg-gradient-to-bl from-gray-200/90 to-gray-400/10 px-5 flex-shrink-0 w-140 min-h-130 rounded-xl shadow-lg group">
                ...
                <div className="w-full flex flex-col border-1 border-white bg-white rounded-2xl p-5 gap-1 items-start transition-colors group-hover:bg-[#5c45bf]  "> 
                  ...
                  <div className="flex justify-between w-full pt-3 items-center">
                    <button className="border-2 rounded-2xl px-4 py-2 font-semibold group-hover:bg-[#e7c84a]">
                      Add to cart
                    </button>
...
//transion ile transion all ferqi
