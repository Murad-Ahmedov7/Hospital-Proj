...
const decreaseCount=()=>{
  ...
  return (
    <div className=" flex  flex-col gap-14 min-h-screen w-screen justify-center items-center pt-[72px]  ">
      ...
      <div className="flex w-screen px-33   relative">
      <img className="rounded-4xl w-full h-[400px]" src="/images/cyan-bg.png"/>

      <div className="flex absolute w-[90%] h-full items-center justify-center">
        <div className=" flex  flex-col gap-7  h-full items-center justify-center  absolute ">
