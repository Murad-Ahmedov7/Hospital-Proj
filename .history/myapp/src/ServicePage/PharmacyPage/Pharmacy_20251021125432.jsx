    ...
    <div className="bg-gradient-to-bl from-blue-300 to-gray-100 w-screen h-screen overflow-hidden">
      <div className="flex flex-col  justify-center items-center h-full gap-7">
        ...
        <div
          ...
          className="flex transition-transform duration-500 ease-out gap-17   min-w-screen overflow-hidden"
        >
          {slides.map((s, index) => (
            <div className="bg-gradient-to-bl from-gray-200/90 to-gray-400/50 px-5 w-70 min-h-full ">

              <div className="flex flex-2 justify-center items-center">
                <img key={index} src={s} alt="Image not available" />
              </div>

              <div className="w-full flex-1 h-20  items-center justify-between">
                <p>Supplement</p>
                <p>4.8/5</p>
              </div>
