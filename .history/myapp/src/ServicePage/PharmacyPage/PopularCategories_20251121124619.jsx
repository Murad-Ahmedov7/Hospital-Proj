...
export default function PopularCategories({categories}) {
  return (
    <div className="flex flex-col justify-center items-center h-[70%]     ">
      ...
      <div className="flex flex-col justify-center items-center h-[10px] ">
      ...
      <div className="flex gap-7 lg:min-w-[600px] lg:max-w-[1000px]  xl:min-w-[800px] xl:max-w-[1040px] 2xl:min-w-[800px] 2xl:max-w-[1300px] ">
        {categories.map((c) => (
