        ...
        <div className=" inner-content flex justify-center  absolute w-[50%] h-[50%] ">
          ...
          <div className="row w-[700px]">
            <div className="outer-left max-w-[600px]">
              ...
              <div className="inner-left min-h-[400px] min-w-[900px] flex flex-col">
                ...
                <p className="text-8xl w-[900px] mt-5 text-white font-oswald  font-bold">Instant Pharmacy Access For You </p>
