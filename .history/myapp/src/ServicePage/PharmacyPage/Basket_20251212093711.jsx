...
const decreaseCount=()=>{
  ...
  return (
    <div className=" flex  flex-col gap-14 min-h-screen w-screen justify-center items-center pt-[72px]  ">
      ...
      <div className=" flex  flex-col gap-3 absolute ">
        <p className="text-white font-bold text-6xl">Shopping Cart </p>
        <p className="text-white text-2xl">Almost there! Review your items and get ready for fast, safe delivery  right to your door. </p>
      </div>
      </div>
