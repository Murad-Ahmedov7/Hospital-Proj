      ...
      <div className="flex justify-center items-center relative">
        ...
        <div className=" inner-content flex flex-col gap-[80px]    absolute w-[77%] h-[80%] ">
          ...
          <div className="row-up flex w-[97%]">
            <div className="outer-left w-[65%]">
              ...
              <div className="inner-left   w-[95%] flex flex-col">
                ...
                <p className="lg:text-6xl  xl:text-7xl 2xl:text-8xl max-w-[987px] mt-7 text-white font-oswald  font-bold">Instant Pharmacy Access For You </p>
         ...
         <div className="row-down flex w-[97%] gap-5">
            <img className="rounded-2xl w-[65%] min-h-[520px]" src="/images/banner-img1.jpg" alt="Picture not available" />
            <img className="rounded-2xl w-[35%] min-h-[520px]" src="/images/banner-img2.jpg" alt="Picture not available" />
          </div>
