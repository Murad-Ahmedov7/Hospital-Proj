...
const [slides, setSlides] = useState([
  ...
  return (
    <div className="bg-gradient-to-bl w-screen h-screen overflow-hidden flex justify-center items-center">
      <div className="flex flex-col justify-center items-center h-full gap-7 w-full max-w-[1300px]">
        <p className="text-gray-600 text-2xl font-bold">Top Choices</p>
        <p className="font-bold text-5xl">Our Most-liked Products</p>
        ...
        >
          {slides.map((s, i) => (
            <SwiperSlide key={i}>
              <div className="bg-gradient-to-bl from-gray-200/90 to-gray-400/10 px-5 w-full min-h-[400px] rounded-xl flex-shrink-0">
                <div className="flex h-[68%] justify-center items-center">
                  <img src={s.src} alt="Image not available" className="h-full object-contain" />
                </div>

                <div className="w-full flex flex-col border border-white bg-white rounded-2xl p-5 gap-1 items-start hover:bg-[#5c45bf] transition-all duration-300">
                  <div className="flex justify-between w-full">
                    <p>Supplement</p>
                    <p>⭐4.8/5</p>
                  </div>
