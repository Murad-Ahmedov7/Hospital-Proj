...
export default function Service() {
  ...
  return (
    <div id="services" className="flex flex-col min-h-screen   bg-gradient-to-bl from-blue-300 to-white  2xl:min-h-[900px] justify-center  ">
      <div className=" flex flex-col items-center  pb-10 ml-5 mt-10 ">
