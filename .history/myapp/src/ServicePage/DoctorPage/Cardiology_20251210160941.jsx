...
export default function Cardiology() {
  return (
    <div className=" flex flex-col items-center gap-8    min-h-screen w-screen pt-[72px] ">
      ...
      <div className="flex justify-start w-[40.5%] h-[380px]   shadow-2xl rounded-2xl">
        ...
        <div className=" flex flex-col gap-3  w-full px-10 overflow-y-auto overflow-x-auto         ">

          <div className="flex flex-col items-center gap-4 h-[70vh] mr-10 rounded-2xl pl-4 pt-4 ">
  ...
  {medicinesData.map((vital) => (
    <div
      key={vital.id}
      className={`rounded-2xl border-l-4 min-w-[330px] ${vital.borderColor} h-20 bg-gray-100/60
...
{/* --- End Modern Consultation Reminder --- */}
      ...
      {/* DOCTOR TIPS */}
      <div className="w-[80%] bg-white rounded-2xl shadow-xl border border-gray-200 p-6 mr-1">
