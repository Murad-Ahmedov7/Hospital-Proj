...
export default function Department() {
  ...
  return (
    ...
    //   <div className="grid grid-cols-4 grid-rows-2 items-center justify-center p-44 w-screen h-screen overflow-hidden gap-22 absolute top-15 left-0 ">
    //     {departments.map((department) => (
    //       <Link key={department.id} className="text-3xl border-1 font-bold p-4  text-black">
    //           <img
    //          className={`${department.width} ${department.height} bg-black`}
    //           src={department.img}
    ...
    <div class="h-screen bg-blue-200 mt-333">
  <div class="h-screen bg-red-200">İç div</div>
</div>
