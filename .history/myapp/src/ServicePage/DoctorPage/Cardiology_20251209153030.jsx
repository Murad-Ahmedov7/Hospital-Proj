          ...
          <div className="flex flex-col gap-4 h-[70vh] mr-10 bg-white rounded-2xl pl-4 pt-4    ">
            ...
            <div className="w-[99%] lg:h-[240px] xl:h-[200px] bg-yellow-300/20  rounded-2xl ">
                ...
                <div className="p-4">
                  ...
                  <button className="bg-blue-500 w-[200px] text-white font-oswald  h-[40px]  rounded-2xl text-[15px] hover:scale-105 transition-transform  duration-300 ease-in shadow-md hover:shadow-xl cursor-pointer ">Ask AI for Approximete Risk </button>
                  </div>
