export default function DoctorTable() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen w-full pt-[72px] overflow-auto">
      ...
      <tr>
      {/* 09:00 və 10:00 birlikdə */}
      <td className="border p-2 text-center h-[120px]" rowSpan={2}>
        09:00 - 10:00
      </td>
      <td className="border p-2 text-center">data</td>
      {/* <td className="border p-2 text-center">data</td> */}
    </tr>
    <tr>
      {/* 09:00-10:00 td artıq burada yoxdur */}
      <td className="border p-2 text-center">data</td>
      <td className="border p-2 text-center">data</td>
    </tr>
