...
{/* //realtive absolute ferqini de  */}
  ...
  {/* <div className="flex absolute items-end  h-[600px]  ">
    <p> See Doctors' schedule</p>
  </div>   */}


<div className="absolute bottom-50 top-50 w-full flex justify-center">
  <p className="text-white text-lg font-bold">See Doctors' schedule</p>
</div>
