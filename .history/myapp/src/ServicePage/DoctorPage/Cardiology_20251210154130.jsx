...
export default function Cardiology() {
  return (
    <div className=" flex flex-col items-center gap-8    min-h-screen w-screen pt-[72px] ">
      ...
      <div className="flex justify-start w-[35%] h-[415px]   overflow-y-auto     shadow-2xl rounded-2xl">
...
<div className="mt-4 w-[35%] rounded-2xl bg-white/60 backdrop-blur-md h-[400px] shadow-lg p-5 border border-gray-200 transition-all duration-300 hover:shadow-xl">

  {/* Header */}
           <div className="flex items-center gap-3  mb-8   px-4 py-2 rounded-xl w-fit shadow-sm">
