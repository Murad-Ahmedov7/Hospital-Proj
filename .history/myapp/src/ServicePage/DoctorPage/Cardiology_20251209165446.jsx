...
export default function Cardiology() {
  return (
    <div className=" flex flex-col items-center gap-8    min-h-screen w-screen pt-[72px] ">
      ...
      <div className="flex justify-start w-[35%] h-[540px]   overflow-y-auto     shadow-2xl rounded-2xl">
           ...
           <div className="flex items-center gap-3  px-4 py-2 rounded-xl w-fit shadow-sm">
            ...
            <div>
              {medicinesData.map((vital) => (
                <div
                  key={vital.id}
                  className="flex flex-col justify-start p-4 gap-1 rounded-2xl  h-20  hover:scale-105 transition-transform  duration-300 ease-in shadow-md hover:shadow-xl cursor-pointer">
      ...
      <div className="flex justify-start w-[40%] h-[540px]   overflow-y-auto     shadow-2xl rounded-2xl">
