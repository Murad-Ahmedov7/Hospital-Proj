...
export default function Department() {
 ...
 <div className="relative w-screen min-h-screen ">
  ...
  {/* Başlıq */}
  <div className="absolute top-0 bottom-140 flex items-center justify-center  w-full text-center text-white text-4xl font-bold z-10">
    Departments
  </div>

{/* basliga top ve bottom elave etdim 
ve grid container pt-7 */}

  {/* Grid container */}
  <div className="relative z-10 flex justify-center items-center min-h-screen px-10 pt-7">
