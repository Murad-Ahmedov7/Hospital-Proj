...
export default function Cardiology() {
  return (
    ...
    <div className=" flex w-full h-full pt-[72px]    bg-gray-300">
        
      <div className=" flex flex-col gap-3 w-screen items-center   ">
        <p className=" font-bold text-xl font-oswald">Hello, User 🖐</p>
        <p className="font-oswald">Here is your latest health update</p>

        <div className="max-w-full h-[70vh] mr-10 bg-white rounded-2xl  ">
