...
<div className="mt-4 w-[35%] rounded-2xl bg-white/60 backdrop-blur-md shadow-lg p-5 border border-gray-200 transition-all duration-300 hover:shadow-xl flex flex-col">
