    ...
    return (
        ...
        <div className=" flex w-full h-full     bg-gray-300/30 rounded-2xl items-center  ">
    ...
    <p className="font-oswald font-semibold text-lg text-gray-800">
        Current Vitals
                ...
                <div className=" grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 w-full gap-4 justify-center ">
