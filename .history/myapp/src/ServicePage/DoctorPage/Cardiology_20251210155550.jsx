...
export default function Cardiology() {
  return (
    <div className=" flex flex-col items-center gap-8    min-h-screen w-screen pt-[72px] ">
      ...
      <div className="flex justify-start w-[40%] h-[380px]   overflow-y-auto     shadow-2xl rounded-2xl">
...
<div className=" w-[40  %] rounded-2xl bg-white/60 backdrop-blur-md h-[380px] shadow-lg p-5 pt-6 border border-gray-200 transition-all duration-300 hover:shadow-xl">
