...
export default function Department() {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden ">
      ...
      <div className="grid grid-cols-4 grid-rows-2 items-center justify-center p-44 w-screen h-screen overflow-hidden gap-22 absolute top-15 left-0 items-center ">
