...
export default function Department() {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden ">
      ...
      <div className="grid grid-cols-4 grid-rows-2 mt-5 xl:py-30  w-screen min-h-screen px-10  absolute top-15 left-0 gap-7 ">
        {departments.map((department) => (  
          <Link
            key={department.id}
            className="text-3xl border rounded-2xl hover:shadow-2xl w-full min-h-[212px] font-bold text-white flex items-center justify-center flex-col gap-7  "
            // to={department.Link}
          >
            <img
