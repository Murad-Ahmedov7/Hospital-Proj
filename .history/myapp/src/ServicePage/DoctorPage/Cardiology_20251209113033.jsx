  ...
  {vitalsData.map((vital) => (
    <div
      key={vital.id}
      className={`flex flex-col justify-start p-4 gap-1 rounded-2xl ${vital.bgColor} hover:bg-gradient-to-b hover:from-cyan-400 hover:to-black/20 hover:text-white shadow-md hover:shadow-xl cursor-pointer`}
    >
      <div className="flex items-center gap-2">
        {vital.Icon}
        <p className="font-semibold">{vital.title}</p>
      </div>
