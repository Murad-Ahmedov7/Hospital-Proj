           ...
           <div className="flex items-center gap-3  px-4 py-2 rounded-xl w-fit shadow-sm">
            ...
            <div>
              {medicinesData.map((vital) => (
                <div
                  key={vital.id}
                  className="flex flex-col justify-start p-4 gap-1 rounded-2xl  h-20 bg-gray-100  hover:scale-105 transition-transform  duration-300 ease-in shadow-md hover:shadow-xl cursor-pointer">
