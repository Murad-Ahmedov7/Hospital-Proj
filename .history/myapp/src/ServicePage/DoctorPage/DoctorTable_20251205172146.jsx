export default function DoctorTable() {
  ...
  return (
    ...
    {/* Data td-ləri iki sətir boyunca yayılır */}
    <td className="border p-2 text-center h-[202px]" rowSpan={2}>
      data
    </td>
  </tr>
  <tr>
    <td className="border p-2 text-center h-[101px]">11:00</td>
    {/* Burada artıq data td yoxdur, çünki yuxarıdakı td ilə birləşdirilib */}
  </tr>
           ...
           <td className="border p-2 text-center h-[101px] ">12:00</td>
            ...
            <tr>
           <td className="border p-2 text-center h-[101px] ">14:00</td>
          </tr>
