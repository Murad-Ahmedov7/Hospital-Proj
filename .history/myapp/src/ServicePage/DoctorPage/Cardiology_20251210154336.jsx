...
<div className=" w-[35%] rounded-2xl bg-white/60 backdrop-blur-md h-[390px] shadow-lg p-5 pt-6 border border-gray-200 transition-all duration-300 hover:shadow-xl">
