...
export default function Department() {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden @min-3xl:w-3000">
      ...
      <div className="grid grid-cols-4 grid-rows-2 mt-5 xl:py-30  w-screen min-h-screen px-20  absolute top-15 left-0 ">
        {departments.map((department) => (  
          <Link
            key={department.id}
            className="text-3xl border rounded-2xl hover:shadow-2xl w-[320px] h-[215px] font-bold text-white flex items-center justify-center flex-col gap-1 "
            // to={department.Link}
          >
            <img
