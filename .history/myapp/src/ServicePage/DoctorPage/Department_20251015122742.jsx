    ...
    <div className="relative w-screen h-screen ">
      ...
      <div className="grid grid-cols-4 grid-rows-2    mt-12 xl:py-4    w-screen h-screen overflow-hidden gap-22 absolute top-15 left-0 ">
        ...
        {departments.map((department) => (
          <Link key={department.id} className="text-3xl border-1 rounded-2xl hover:shadow-2xl blue  font-bold   text-white flex items-center justify-center flex-col gap-6">
              <img
