...
export default function Cardiology() {
  ...
  {/* --- Consultation Reminder Section --- */}
            <div className="mt-4 w-full bg-white rounded-2xl shadow-md p-4 border">
              <p className="font-oswald font-semibold text-lg mb-3">
                Consultation Reminder
              </p>

              {/* Appointment Alert */}
              <div className="bg-red-100 border-l-4 border-red-500 p-3 rounded-md mb-3">
                <p className="text-red-700 font-semibold text-sm">Upcoming Appointment</p>
              ...
              <div className="bg-blue-50 border rounded-md p-3 mb-3">
                <p className="text-gray-600 text-sm">Next Consultation Date</p>
                <p className="font-oswald font-bold text-gray-800">Tomorrow, 11:00 AM</p>
              </div>

              {/* Schedule Button */}
              <button className="bg-blue-500 w-full text-white font-oswald h-[45px] rounded-xl text-[15px] hover:scale-105 transition-transform duration-300 ease-in shadow-sm hover:shadow-xl">
                Schedule New Appointment
              </button>
            </div>
            {/* --- End Consultation Reminder --- */}
