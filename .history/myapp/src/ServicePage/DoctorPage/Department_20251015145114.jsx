...
export default function Department() {
  ...
  return (
    <div className="relative min-h-screen min-w-screen overflow-x-hidden">
      ...
      <img src="/images/surgeryimg.jpg" alt="This picture is not found" className=" object-cover w-full" />
      <div className="absolute inset-0 bg-[#3AA6B9]/90"></div>

      <div className="grid grid-cols-4 grid-rows-2 mt-20 xl:py-3 min-w-screen    gap-22 absolute top-15 left-0">
