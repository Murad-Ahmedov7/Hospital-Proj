    ...
    <p className=" absolute ">Departments</p>  
      <div className="grid grid-cols-4 grid-rows-2    mt-12 xl:py-4    w-screen h-screen overflow-hidden gap-22 absolute top-15 left-0 ">
        ...
        {departments.map((department) => (
          <Link key={department.id} className="text-3xl border-1 rounded-2xl hover:shadow- to-red-500  font-bold   text-white flex items-center justify-center flex-col gap-6">
              <img
