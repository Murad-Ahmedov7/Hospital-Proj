...
export default function Department() {
  ...
  return (
    <div className="relative min-w-screen min-h-screen ">
      ...
      <div className="grid grid-cols-4 grid-rows-2 mt-20 xl:py-3 w-screen min-h-screen    gap-22 absolute top-15 left-0 ">
        {departments.map((department) => (
          <Link
            key={department.id}
            className="text-3xl border rounded-2xl hover:shadow-2xl font-bold text-white flex  flex-col gap-6"
            // to={department.Link}
          >
            <img
