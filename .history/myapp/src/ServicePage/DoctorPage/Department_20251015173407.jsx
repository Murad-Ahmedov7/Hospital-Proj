...
export default function Department() {
 ...
 <div className="relative w-screen min-h-screen">
  ...
  {/* Başlıq */}
  <div className="absolute top-15 w-full text-center text-white text-4xl font-bold z-10">
    Departments
  </div>

  {/* Grid container */}
  <div className="relative z-10 flex justify-center items-center min-h-screen px-10 mt-2">
