    ...
    <div className=" flex justify-center  h-screen w-screen pt-[72px]">
      <div className=" flex w-[80%] h-full     bg-gray-300 items-center ">
        <div className=" flex flex-col gap-3 w-screen px-10    ">
          ...
          <div className=" h-[70vh] mr-10 bg-white rounded-2xl gap-0  ">

         <p className=" font-bold text-xl font-oswald p-3">Hello, User 🖐</p>
          <p className="font-oswald p-3 ">Here is your latest health update</p>
