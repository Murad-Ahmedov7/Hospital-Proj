    ...
    <p className="font-oswald font-semibold text-lg text-gray-800">
        Current Vitals
                ...
                {vitalsData.map((vital) => (
                    <div
                    key={vital.id}
        className={`flex flex-col justify-start p-4 gap-1 rounded-2xl ${vital.bgColor} text-white hover:scale-105 transition-transform easi duration-300 shadow-md hover:shadow-xl cursor-pointer`}
                    >
