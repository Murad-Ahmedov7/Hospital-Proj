    ...
    <p className="font-oswald font-semibold text-lg text-gray-800">
        Current Vitals
                ...
                <div className=" grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 w-full gap-4 justify-center px-3 ">

            {Array.from({ length: 5  }).map((_, index) => (
        <div
        key={index}
        className="
            w-[100%] h-[100px] rounded-2xl flex flex-col justify-start p-4 gap-1
