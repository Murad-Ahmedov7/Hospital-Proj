...
export default function Department() {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden ">
      ...
      <img src="/images/surgeryimg.jpg" alt="This picture is not found" className=" object-cover min-h-screen w-screen" />
      <div className="absolute inset-0 bg-[#3AA6B9]/90"></div>

      <div className="grid grid-cols-4 grid-rows-2  xl:py-30  w-screen   px-10  absolute top-15 left-0 gap-7   ">
        {departments.map((department) => (  
          <Link
            key={department.id}
            className="text-3xl border rounded-2xl hover:shadow-2xl w-full h-[212px] font-bold text-white  flex-col gap-7  "
            // to={department.Link}
          >
            <img
