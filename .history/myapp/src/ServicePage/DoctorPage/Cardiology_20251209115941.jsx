          ...
          <div className="flex flex-col gap-4 h-[70vh] mr-10 bg-white rounded-2xl pl-4 pt-4   ">
            ...
            <div className=" grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 w-full gap-4 justify-start pr-5">
              {vitalsData.map((vital) => (
                <div
                  key={vital.id}
                  className="flex flex-col justify-start p-4 gap-1 rounded-2xl bg-cyan-400/40   hover:scale-105 transition-transform  duration-300 ease-in shadow-md hover:shadow-xl cursor-pointer"
                >
                  <div className="flex items-center gap-2">
                    <vital.Icon size={30} /> 
                    <p className="font font-oswald">{vital.title}</p>
                  </div>
            ...
            <div className="w-full h-[25%] bg-yellow-300/30 pr-30 rounded-2xl">
                <div className="p-4">
                    <p>Ai Approximete Heart Disease Risk</p>
                </div>
            </div>
          </div>
        </div>
