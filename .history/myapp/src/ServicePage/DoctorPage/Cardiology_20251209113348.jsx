    ...
    <p className="font-oswald font-semibold text-lg text-gray-800">
        Current Vitals
                ...
                {vitalsData.map((vital) => (
                    <div
                    key={vital.id}
                    className="flex flex-col  p-4 gap-1 rounded-2xl bg-cyan-400  hover:bg-gradient-to-b hover:from-cyan-400 hover:to-black/20 shadow-md hover:shadow-xl cursor-pointer"
                    >
