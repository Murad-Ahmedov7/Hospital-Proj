...
export default function Department() {
  ...
  return (
    <div className="relative ">
      ...
      <img src="/images/surgeryimg.jpg" alt="This picture is not found" className=" object-cover h-screen w-screen" />
      <div className="absolute inset-0 bg-[#3AA6B9]/90"></div>

      <div className="grid grid-cols-4 grid-rows-2 mt-20 xl:py-3    gap-22 absolute top-15 left-0">
        {departments.map((department) => (
          <Link
            key={department.id}
            className="text-3xl border rounded-2xl hover:shadow-2xl font-bold text-white flex items-center justify-center flex-col gap-6 w-screen"
            // to={department.Link}
          >
            <img
