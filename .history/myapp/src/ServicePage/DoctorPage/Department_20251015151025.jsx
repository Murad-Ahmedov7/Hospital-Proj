...
export default function Department() {
  ...
  return (
    <div className="relative min-w-screen min-h-screen ">
      ...
      <img src="/images/surgeryimg.jpg" alt="This picture is not found" className=" object-cover min-h-screen min-w-screen" />
      <div className="absolute inset-0 bg-[#3AA6B9]/90"></div>

      <div className="grid grid-cols-4 grid-rows-2 mt-20 xl:py-3 min-w-screen min-h-screen    gap-20 absolute top-[60px] left-0 ">
