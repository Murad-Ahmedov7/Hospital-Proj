...
export default function Department() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="grid grid-cols-4 grid-rows-2 items-center justify-center p-44 w-400 h-300 ">
        {departments.map((d) => (
          <Link key={d.id} className="text-3xl border-1 font-bold px-4    text-black">
            {d.title}
          </Link>
        ))}
      </div>
