...
export default function Department() {
  ...
  {/* Başlıq */}
  <div className="absolute top-20 w-full text-center text-white text-4xl font-bold z-10">
    Departments
  </div>

  {/* Grid container */}
  <div className=" z-10 flex justify-center items-center min-h-screen px-10">
    <div className="grid grid-cols-4 grid-rows-2 gap-7 w-full max-w-[1400px]">
