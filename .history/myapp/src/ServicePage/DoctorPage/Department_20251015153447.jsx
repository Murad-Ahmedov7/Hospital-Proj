...
export default function Department() {
  ...
  return (
    <div className="relative w-screen min-h-screen overflow- ">
      ...
      <img src="/images/surgeryimg.jpg" alt="This picture is not found" className=" object-cover min-h-[110vh] min-w-screen" />
      <div className="absolute inset-0 bg-[#3AA6B9]/90"></div>

      <div className="grid grid-cols-4 grid-rows-2 mt-5 xl:py-30 min-w-screen min-h-screen px-10    absolute top-15 left-0 ">
        {departments.map((department) => (  
          <Link
            key={department.id}
            className="text-3xl border rounded-2xl hover:shadow-2xl w-[320px] h-[215px] font-bold text-white flex items-center justify-center flex-col gap-6"
            // to={department.Link}
          >
            <img
