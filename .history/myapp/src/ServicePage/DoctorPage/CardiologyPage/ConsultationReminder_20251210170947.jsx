...
export default function ConsultationReminder() {
  return (
    <div className="w-[39%] rounded-2xl bg-white/60 backdrop-blur-md h-[380px] shadow-lg p-5 pt-6 border border-gray-200 transition-all duration-300 hover:shadow-xl">
      ...
      <button className="mt-5 w-full h-[48px] rounded-xl bg-gradient-to-r from-blue-500 to-blue-600 text-white font-oswald text-[15px] font-semibold shadow-md hover:shadow-lg hover:scale-[1.03] transition-all duration-300">
