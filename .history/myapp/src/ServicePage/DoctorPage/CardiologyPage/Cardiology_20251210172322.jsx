...
export default function Cardiology() {
 ...
 <div className="flex flex-col items-center gap-8 min-h-screen w-screen pt-[72px]">
      <div className="flex flex-col w-[80%] h-[740px] overflow-y-auto shadow-2xl rounded-2xl px-10">
        
        <CurrentVitals vitalsData={vitalsData} />
        <HeartRisk />
      </div>

      <div className="flex w-full justify-center gap-3">
        <Medications medicinesData={medicinesData} />
