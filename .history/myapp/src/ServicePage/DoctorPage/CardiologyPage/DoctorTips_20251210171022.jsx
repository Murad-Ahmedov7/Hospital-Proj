    ...
    <div className="w-[80%] bg-white/80 backdrop-blur-md rounded-2xl shadow-lg border border-gray-200 p-6 mr-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {tips.map((tip, i) => (
          <div
            key={i}
            className="bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 rounded-xl p-4 shadow-sm hover:shadow-md hover:bg-gray-50 transition-all duration-300 ease-out"
          >
