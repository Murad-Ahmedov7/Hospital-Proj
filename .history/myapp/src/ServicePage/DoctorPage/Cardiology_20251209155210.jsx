...
export default function Cardiology() {
  return (
    <div className=" flex flex-col items-center gap-8    min-h-screen w-screen  ">
      <div className=" flex w-[80%] min-h-screen items-center    overflow-y-auto     shadow-2xl rounded-2xl   ">
