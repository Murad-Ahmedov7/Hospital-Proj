           ...
           <div className="flex items-center gap-3  px-4 py-2 rounded-xl w-fit shadow-sm">
            ...
            <div className="flex flex-col gap-3">
              {medicinesData.map((vital) => (
                <div
                  key={vital.id}
                  className={`rounded-2xl border-l-3 ${vital.borderColor}  h-20 bg-gray-100/60  hover:scale-105 transition-transform  duration-300 ease-in shadow-md hover:shadow-xl cursor-pointer`}>
