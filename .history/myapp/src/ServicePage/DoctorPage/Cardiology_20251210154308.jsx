...
<div className=" w-[35%] rounded-2xl bg-white/60 backdrop-blur-md h-[400px] shadow-lg p-5 mt-3 border border-gray-200 transition-all duration-300 hover:shadow-xl">
