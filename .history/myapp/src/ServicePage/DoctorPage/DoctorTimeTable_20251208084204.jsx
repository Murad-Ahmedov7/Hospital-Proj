    ...
    <div className="flex items-center justify-center min-h-screen w-full pt-[72px] overflow-auto">
      <table className="w-[80vw] border border-gray-300">
        ...
        <tbody>
          ...
          <tr>
            <td className="border p-2 text-center w-[100px] h-[3  0px]">09:00</td>

            <td className="border p-2 text-center w-[200px] h-[202px] " rowSpan={2}>
             <div>
          ...
          <tr>
            <td className="border p-2 text-center  w-[100px] h-[30px] ">10:00</td>
          </tr>
