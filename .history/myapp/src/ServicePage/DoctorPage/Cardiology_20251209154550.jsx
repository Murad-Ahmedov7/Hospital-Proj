...
export default function Cardiology() {
  return (
    <div className=" flex flex-col items-center gap-8    min-h-screen w-screen pt-[72px] ">
      <div className=" flex w-[80%] min-h-screen 2xl:overflow-hidden   overflow-y-auto     shadow-2xl rounded-2xl   ">
                ...
                <div className="p-4">
                  ...
                  <div className="flex flex-col w-[100%] gap-3 mb-3  ">
                      ...
                      <div className="border-1 rounded-2xl h-4 w-full ">
                        ...
                        <p className="w-[240px] font-oswald font-bold">40%(Moderate)</p>
