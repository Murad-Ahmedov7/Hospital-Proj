...
export default function Department() {
  ...
  return (
    <div className="relative min-w-screen min-h-screen ">
      ...
      <div className="grid grid-cols-4 grid-rows-2 mt-14 xl:py-30 w-screen min-h-screen px-10    gap-10 absolute top-15 left-0 ">
        {departments.map((department) => (
          <Link
            key={department.id}
            className="text-3xl border rounded-2xl hover:shadow-2xl w-[230px] h-[215px] font-bold text-white flex items-center justify-center flex-col gap-6"
            // to={department.Link}
          >
            <img
