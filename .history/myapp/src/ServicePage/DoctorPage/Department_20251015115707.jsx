...
export default function Department() {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden ">
      ...
      <div className="grid grid-cols-4 grid-rows-2 px-44   w-screen h-screen overflow-hidden gap-22 absolute top-15 left-0 ">
        {departments.map((department) => (
          <Link key={department.id} className="text-3xl border-1 font-bold p-4  text-white flex items-center justify-center flex-col">
              <img
