...
export default function Department() {
  ...
  return (
    <div className="relative min-w-screen min-h-screen overflow-y-hidden ">
      <img src="/images/surgeryimg.jpg" alt="This picture is not found" />
      <div className="absolute inset-0 bg-[#3AA6B9]/90  z-0"></div>

      <div className="grid grid-cols-4 grid-rows-2 items-center justify-center p-44 min-w-screen min-h-screen overflow-y-hidden gap-22 absolute top-15 left-0 ">
