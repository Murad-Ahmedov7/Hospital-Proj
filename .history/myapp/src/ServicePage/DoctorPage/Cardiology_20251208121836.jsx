...
export default function Cardiology() {
  return (
    ...
    <div className=" flex w-[80%] h-full     bg-gray-300">
      ...
      <div className=" flex flex-col gap-3 w-screen px-10   ">
        ...
        <div className=" h-[70vh] mr-10 bg-white rounded-2xl  ">
...
<div className="flex w-full gap-4 justify-center">
  <div className="w-[400px] h-[100px] rounded-2xl flex flex-col items-center justify-center gap-1
                  border border-cyan-300 
                  bg-white
                  hover:bg-gradient-to-r hover:from-cyan-400 hover:to-cyan-600 
                  hover:text-white
