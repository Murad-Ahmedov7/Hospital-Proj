...
export default function Cardiology() {
  return (
    <div className=" flex flex-col items-center gap-5     min-h-screen w-screen pt-[72px] ">
      <div className=" flex w-[80%] min-h-screen     bg-gray-300/30 rounded-2xl items-center  ">
     ...
     <div className="flex w-[80%]  min-h-screen     bg-gray-300/30 rounded-2xl items-center">
         <div className=" flex flex-col gap-3  w-screen px-10    ">
      <div className="flex flex-col gap-4 h-[70vh] mr-10 bg-white rounded-2xl pl-4 pt-4    "></div>
         </div>
