...
export default function Department() {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden ">
      <div className=" absolute flex justify-center items-center font-bold text-white mt-17 text-4xl  w-full  z-10">
      ...
      <div className="grid grid-cols-4 grid-rows-2    mt-20 xl:py-4    w-screen h-screen overflow-hidden gap-22 absolute top-15 left-0 ">
        {departments.map((department) => (
          <Link
            key={department.id}
            className="text-3xl border-1 rounded-2xl hover:shadow-2xl  font-bold    text-white flex items-center justify-center flex-col gap-6"
          >
            <img
