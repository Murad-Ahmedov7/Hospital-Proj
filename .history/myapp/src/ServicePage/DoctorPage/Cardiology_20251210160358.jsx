...
export default function Cardiology() {
  return (
    <div className=" flex flex-col items-center gap-8    min-h-screen w-screen pt-[72px] ">
      ...
      <div className="flex justify-start w-[40.5%] h-[380px]   overflow-y-auto     shadow-2xl rounded-2xl">
  ...
  {medicinesData.map((vital) => (
    <div
      key={vital.id}
      className={`rounded-2xl border-l-4 min-w-[530px] ${vital.borderColor} h-20 bg-gray-100/60
