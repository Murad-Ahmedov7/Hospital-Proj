...
export default function Cardiology() {
  return (
    <div className=" flex flex-col items-center gap-8    min-h-screen w-screen pt-[72px] ">
      ...
      <div className="flex justify-start w-[35%] h-[380px]   overflow-y-auto     shadow-2xl rounded-2xl">
...
<div className=" w-[35%] rounded-2xl bg-white/60 backdrop-blur-md h-[380px] shadow-lg p-5 pt-6 border border-gray-200 transition-all duration-300 hover:shadow-xl">

  {/* Header */}
           <div className="flex items-center gap-3  mb-7   px-4 py-2 rounded-xl w-fit shadow-sm">

              <CiBellOn size={32} className="text-cyan-600" />
  ...
  {/* Appointment Alert */}
  <div className="flex items-start gap-3 bg-red-50 border border-l-3 border-red-500 p-4 rounded-xl shadow-sm">
