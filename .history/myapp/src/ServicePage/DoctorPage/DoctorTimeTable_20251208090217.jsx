      ...
      <table className="w-[80vw] border border-gray-300">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td className="border p-2 text-center w-[180px] h-[190px] bg-[#F1F7F3] " rowSpan={2}>
             <div>
              <p className="text-[17px] font-oswald ">Radiation Therapy</p>
              <p className=" font-oswald text-[14px]">09:00-11:00</p>
              <p className=" font-oswald">Dr Whitney Rain</p>
             </div>
            </td>
