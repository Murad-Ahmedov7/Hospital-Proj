...
<div className='w-screen h-screen caret-transparent bg-zinc-800 flex flex-col justify-center items-center gap-y-2'>
  ...
  <div className={` ${onClose?"h-1/9 w-[97%] flex items-center ":"h-4/6 w-5/6"} transition-all ease-in duration-1200 bg-white rounded-xl p-4 ` }>
  ...
  <div onClick={()=>handleCloseBtn()} className="flex-col items-center gap-2 cursor-pointer">
