...
<div className='w-screen h-screen   bg-zinc-800 flex flex-col justify-center items-center gap-y-2 '>  {/* umumi div */}
 

  
  <div className={` ${onClose?"h-[7%] w-[97%] flex items-center hover:  ":"h-4/6 w-5/6"} transition-all ease-in duration-1200 bg-white rounded-xl py-4 px-7 overflow-hidden ` }>   {/* tablenin col divi */}
        ...
        <table className="min-w-full text-center text-md text-gray-700">
          ...
          <tbody className="divide-y divide-gray-100">
            {allconsult.map((item) => (
              ...
              >
                <td className="px-9 py-3 text-gray-800">{item.id}</td>
                <td className="px-9 py-3">{item.name}</td>
                <td className="px-9 py-3">{item.email}</td>
                <td className="px-9 py-3">{item.phone}</td>
                <td className="px-9 py-3">{item.date}</td>
                <td className="px-9 py-3">{item.staff}</td>
                <td className="px-9 py-3">{item.message}</td>
                <td className="px-9 py-3 text-[#3AA6B9] font-bold">{item.service}</td>
                <div className='bg-yellow-50 '><td className="px-9  text-center py-3  font-bold  ">🟨Pending</td></div>
                <td>N/A</td>
                <td>N/A</td>
                <td>N/A</td>
