          ...
          {!onClose && (
            <div className="mt-4 overflow-y-auto max-h-[85%] rounded-lg">
              <div className="mb-3 flex gap-3 ">
                <p className="text-[20px] font-semibold font-oswald">Filter</p>
                <select className="text-[20px] font-bold font-oswald">
                  <option className="text-[20px]">Name</option>
                  <option className="text-md">Email</option> 
                  <option className="text-md">Staff</option>
                  <option className="text-md">Service</option>
                </select>
              </div>
