...
<div className='w-screen h-screen   bg-zinc-800 flex flex-col justify-center items-center gap-y-2 '>  {/* umumi div */}
  ...
  <div onClick={()=>handleCloseBtn()} className="flex items-center gap-2 cursor-pointer overflow-y-auto "> {/* toggle duymesi */}
  ...
  {
  !onClose&&(
<div className="w-full  bg-white p-6 mt-4 rounded-2xl shadow-xl shadow-gray-300     ">
      ...
      <tbody className="divide-y divide-gray-100">
        {allconsult.map(item => (
          ...
          >
            ...
            <td className="px-4 py-3 text-[#3AA6B9] font-bold">{item.service}</td>
          </tr>
        ))}
      </tbody>
    </table>
