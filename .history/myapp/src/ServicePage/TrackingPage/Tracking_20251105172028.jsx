...
<div className='w-screen h-screen caret-red-400 bg-zinc-800 flex flex-col justify-center items-center gap-y-2'>
  <div className='w-5/6 h-5/6 bg-white rounded-xl'></div>
</div>
