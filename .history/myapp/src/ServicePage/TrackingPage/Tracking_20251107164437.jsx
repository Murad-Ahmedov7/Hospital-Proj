...
// Pagination: [Prev] [1] [2] [Next] */}
  ...
  console.log(`${searchText}searchText`); // köhnə state
  console.log(e.target.value); // yeni dəyər
}} className="text-[18px] font-bold font-oswald bg-gray-200 rounded-xl h-[40px] ">
                  {
