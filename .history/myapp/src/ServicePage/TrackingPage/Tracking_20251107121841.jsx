    ...
    allconsult.map((a)=>(
      ...
      <div className="w-screen h-screen   bg-zinc-800 flex flex-col justify-center items-center gap-y-2 ">
        ...
        <div
          className={` ${
            onClose
              ? "h-[7%] w-[97%] flex items-center hover:  "
              : "h-4/6 w-5/6"
          } transition-all ease-in duration-1200 bg-white rounded-xl py-4 px-7 overflow-hidden `}
        >
          {" "}
          {/* tablenin col divi */}
          <div
          ...
          {!onClose && (
            <div className="mt-4 overflow-y-auto max-h-[85%] rounded-lg">
              <div className="mb-3 flex gap-1 ">
                ...
                <select className="text-[18px] font-bold font-oswald bg-gray-200 rounded-xl ">
                  {/* <option value='name' className="text-[18px] bg-white   ">Name</option>
                  <option className="text-[18px] bg-white">Email</option> 
                  <option className="text-[18px] bg-white">Staff</option>
                  <option className="text-[18px] bg-white">Service</option> */}

                  {
                    filterNames.map((f,index)=>(
                      <option className="text-[18px] font-bold font-oswald bg-gray-200 rounded-xl "  value={f.value} key={index}>{f.name}</option>
                    ))
                  }
                </select>
              </div>
                  ...
                  {allconsult.map((item) => (
                    ...
                    >
                      ...
                      <div className="bg-yellow-50 ">
                        <td className="px-4 py-3  font-bold  ">🟨Pending</td>
                      </div>
                      <td>N/A</td>
                      <td>N/A</td>
                      <td>N/A</td>
