...
// Pagination: [Prev] [1] [2] [Next] */}
          ...
          {!onClose && (
            <div className="mt-4 overflow-y-auto max-h-[85%] rounded-lg">
              ...
              <div className="w-full flex gap-7 items-center ">      {/* filter and search div  */}
              <div className="mb-3 flex gap-2">        {/* filter div */}
              ...
              <div onClick={()=>handleToggleSearch()} className="flex  gap-2 ">  {/* search div*/}
                <FaSearch  size={25} />
                   <p className="text-[20px] font-bold font-oswald">Search</p>              
                           <input placeholder="Search here" className="rounded-2xl border-1"></input>
                   </div>
