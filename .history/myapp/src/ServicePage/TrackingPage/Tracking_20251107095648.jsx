...
<div className="w-full bg-white p-6 mt-7 rounded-2xl shadow-xl shadow-blue-200 ">
    ...
    <table className="min-w-full text-center text-md text-gray-700">
      ...
      <tbody className="divide-y divide-gray-100">
        {allconsult.map(item => (
          <tr
            key={item.id}
            className="hover:bg-blue-50 transition-all duration-200 cursor-pointer font-oswald font-medium"
          >
