          ...
          {!onClose && (
            <div className="mt-4 overflow-y-auto max-h-[85%] rounded-lg">
              <div className="mb-3 flex gap-1 ">
                ...
                <select className="text-[18 px] font-bold font-oswald bg-gray-200 ">
                  <option className="text-[18px] bg-white">Name</option>
                  <option className="text-[18px] bg-white">Email</option> 
                  <option className="text-[20px] bg-white">Staff</option>
                  <option className="text-[20px] bg-white">Service</option>
                </select>
              </div>
