...
<div className='w-screen h-screen   bg-zinc-800 flex flex-col justify-center items-center gap-y-2 '>  {/* umumi div */}
  ...
  <div className={` ${onClose?"h-[7%] w-[97%] flex items-center hover:  ":"h-4/6 w-5/6"} transition-all ease-in duration-1200 bg-white rounded-xl p-4 ` }>   {/* tablenin col divi */}
  ...
  {
  !onClose&&(
<div className="w-full  bg-white p-6 mt-7 rounded-2xl shadow-xl shadow-gray-300 overflow-y-auto h-[90%] overflow-hidden   ">
  <div className="overflow-x-auto rounded-lg ">
    <table className="min-w-full text-center text-md text-gray-700 px-41">
