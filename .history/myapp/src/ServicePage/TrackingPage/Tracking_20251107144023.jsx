...
useEffect(() => {
  // Sort funksiyası ayrıca yazılır (oxunaqlılıq üçün)
  const sortData = (filter, data) => {
    switch (filter) {
      case "name":
  ...
  const sorted = sortData(selectedFilter, allconsult);
  setSortedData(sorted);
}, [selectedFilter, allconsult]);
...
const sorted=sortData(selectedFilter,)
},[])
