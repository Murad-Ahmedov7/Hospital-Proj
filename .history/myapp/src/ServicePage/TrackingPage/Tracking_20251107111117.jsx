        ...
        <table className="min-w-full text-center text-md text-gray-700">
          <thead className="bg-blue-50 text-[#3AA6B9] uppercase tracking-wide border-b border-gray-200">
            <tr>
              ...
              <th className="px-4 py-3">DoctorNotes</th>

              

            </tr>
          </thead>
          <tbody className="divide-y-111 divide-gray-100">
            {allconsult.map((item) => (
              <tr
                key={item.id}
              ...
              >
                ...
                <div className='bg-red-50'><td className="px-4 py-3  font-bold ">🟨Pending</td></div>
              </tr>
            ))}
          </tbody>
        </table>
