...
<div className='w-screen h-screen caret-transparent bg-zinc-800 flex flex-col justify-center items-center gap-y-2'>
  ...
  <div className={`w-5/6 ${onClose?"h-1/6":'h-4/6'} transition-all ease-in-out duration-1000 bg-white rounded-xl` }>
  ...
  <div onClick={()=>handleCloseBtn()} className="flex items-center justify-start ml-10  gap-2 cursor-pointer">
