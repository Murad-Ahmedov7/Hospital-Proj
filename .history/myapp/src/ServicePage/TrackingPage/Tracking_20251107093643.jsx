...
<div className="w-full bg-white p-6 mt-7 rounded-2xl shadow-xl shadow-blue-200 overflow-hidden">
  <div className="overflow-x-auto rounded-lg">
    <table className="min-w-full text-center text-sm text-gray-700">
      <thead className="bg-blue-50 text-blue-600 uppercase tracking-wide border-b border-gray-200">
        <tr>
      ...
      <tbody className="divide-y divide-gray-100">
        {allconsult.map(item => (
          ...
          >
            ...
            <td className="px-4 py-3 text-blue-500 font-semibold">{item.service}</td>
          </tr>
        ))}
      </tbody>
    </table>
