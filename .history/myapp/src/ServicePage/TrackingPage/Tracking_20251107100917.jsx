...
<div className="w-full  bg-white p-6 mt-7 rounded-2xl shadow-xl shadow-gray-300 overflow-y-hidden   ">
  <div className="overflow-x-auto rounded-lg ">
    <table className="w-full text-center text-md text-gray-700">
