...
const filteredData = allConsult.filter((item) => {
  ...
  return (
    <>
      ...
      <div className="w-screen min-h-screen   flex flex-col justify-center items-center gap-y-2 ">
   
      <div className="absolute inset-0 z-0 bg-black opacity-15"> <img src="/images/time_tracking_for_developers.jpg" alt="Image not found "/></div>
