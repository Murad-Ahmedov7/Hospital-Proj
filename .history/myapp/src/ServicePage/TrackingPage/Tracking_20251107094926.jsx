...
<div className='w-screen h-screen   bg-zinc-800 flex flex-col justify-center items-center gap-y-2'>  {/* umumi div */}
  ...
  <div className={` ${onClose?"h-[7%] w-[97%] flex items-center hover:scale-115 ":"h-4/6 w-5/6"} transition-all ease-in duration-1200 bg-white rounded-xl p-4 ` }>   {/* tablenin col divi */}
