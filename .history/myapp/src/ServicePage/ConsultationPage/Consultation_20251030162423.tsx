...
export default function Consultation() {
  ...
  <div className="flex gap-20">
              ...
              <div className="flex flex-col gap-2">
              <label className="font-semibold">NAME</label>
              <input className="border border-gray-300 rounded px-3 py-2 outline-none focus:border-teal-500 focus:border-2 transition-all" type="text" placeholder="Your Name"></input>
              <div className="border-b-1 border-black"></div>
              </div>
