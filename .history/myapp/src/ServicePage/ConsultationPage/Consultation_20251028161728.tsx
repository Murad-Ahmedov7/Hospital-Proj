      ...
      <div className=" flex  justify-center  absolute    w-screen h-[700px] mt-20 overflow-hidden">
        ...
        <div className="bg-[#424242] w-[372px] h-[812px] ">
          ...
          <div className="flex gap-4  w-full h-10 mt-8 pl-10 ">
            <button className=" bg-cyan-500 w-50 rounded-[10px] flex">
                   <p className=" text-gray-100 font-semibold text-center"> Talk to a consultant </p>
                    <IoMdChatboxes className="ml-4" size={24} color="white" />
              </button>
