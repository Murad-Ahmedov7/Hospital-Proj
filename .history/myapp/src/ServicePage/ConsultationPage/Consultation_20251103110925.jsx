      ...
      <div className=" flex  justify-center   absolute    w-screen h-[670px] mt-20 overflow-hidden">
        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-20">
              ...
              <input {...register("phone",{required:"BU PHONE sahesi mutleqdir"})} type="tel" className="border-b-1 border-gray-300 text-[#b4aab4]   py-2 w-[240px]   outline-none focus:border-teal-500 focus:border-b-2 transition-all" placeholder="Your Phone"></input>
