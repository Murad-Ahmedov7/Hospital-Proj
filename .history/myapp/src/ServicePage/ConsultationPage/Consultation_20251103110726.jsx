      ...
      <div className=" flex  justify-center   absolute    w-screen h-[670px] mt-20 overflow-hidden">
        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-20">
              ...
              <input {...register("phone",{required:"BU PHONE sahesi mutleqdir"})} type='text' className="border-b-1 border-gray-300 text-[#b4aab4]   py-2 w-[240px]   outline-none focus:border-teal-500 focus:border-b-2 transition-all" placeholder="Your Phone"></input>
            ...
            <select {...register("staff",{required:"BU STAFF sahesi mutleqdir"})} className="border-b-1 border-gray-300  py-2 w-[240px]  outline-none text-[#b4aab4]">
              ...
              <input {...register("date",{required:"BU DATE sahesi mutleqdir"})} type="text" className="border-b-1 border-gray-300  py-2 w-[240px]  outline-none focus:border-teal-500 focus:border-b-2 transition-all text-[#b4aab4]"  placeholder="Date cedveli yarat "></input>
              {errors.date && <p className="text-red-500 text-sm"> {errors.staff.message}</p>}
