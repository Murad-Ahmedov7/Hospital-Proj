      ...
      <div className=" flex  justify-center   absolute    w-screen h-[640px] mt-20 overflow-hidden">
        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-20">
              ...
              <input type='number' className="border-b-1 border-gray-300  py-2  outline-none focus:border-teal-500 focus:border-b-2 transition-all" type="text" placeholder="Your Name"></input>
              </div>
