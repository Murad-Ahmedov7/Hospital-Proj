    ...
    <div className="relative w-screen min-h-screen  pt-10">
      ...
      <div className=" flex  justify-center  absolute    w-screen h-[700px] mt-20 overflow-hidden">
        ...
        <div className="bg-[#424242] w-[372px] h-[812px] ">
          <div className=" w-full pl-10 pt-10 gap-5 flex flex-col ">
                 <h1 className="text-white text-[25px] font-bold">Contact Info</h1>
                 <div className="border-1 border-[#14c9e0] bg-[#07afc5] w-12 h-[3px]"></div>
          </div>

          <div className="flex gap-4  w-full h-12 mt-9 pl-9">
            <button className=" bg-cyan-500 w-60  rounded-[10px] flex items-center justify-center gap-3 hover:bg-blue-900 transform  transition duration-3000 ease-in-out hover:scale-110 ">
                   <p className=" text-gray-100 font-semibold "> Talk to a consultant </p>
