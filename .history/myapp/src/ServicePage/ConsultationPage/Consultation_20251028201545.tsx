...
export default function Consultation() {
  ...
  // };
  return (
    <div className="relative w-screen min-h-screen  overflow-hidden r pt-4">
      <img
      ...
      <div className=" flex  justify-center items-center  absolute    w-screen h-[700px] mt-20 overflow-hidden">
