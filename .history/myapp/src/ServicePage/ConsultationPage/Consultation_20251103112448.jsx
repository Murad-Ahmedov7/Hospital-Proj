    ...
    <div className="relative w-screen min-h-screen flex items-center justify-center  overflow-hidden r  pb-4">
      ...
      <div className=" flex  justify-center   absolute    w-screen h-[750px] mt-20 overflow-hidden">
        ...
        <div className="flex flex-col gap-6">
              ...
              <input {...register("name",{required:"BU NAME sahesi mutleqdir",pattern:{ value: /^[A-Z]+$/,}})} className="border-b-1 border-gray-300  py-2 w-[240px]  outline-none  text-[#b4aab4]  focus:border-teal-500 focus:border-b-2 transition-all" type="text" placeholder="Your Name"></input>
