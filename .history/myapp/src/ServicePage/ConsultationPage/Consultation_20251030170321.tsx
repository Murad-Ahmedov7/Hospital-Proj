        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-20">
              ...
              <label className="font-semibold">TYPE OF SERVICES</label>
                <select className="border-b-1 border-gray-300  py-2 w-[240px]  outline-none focus:border-teal-500 focus:border-b-2 transition-all">
              <option value="">Any Service</option>
              <option value="null1">Null1</option>
              <option value="null2">Null2</option>
              <option value="design">Null3</option>
              <option value="marketing">Null4</option>
                </select>
