      ...
      <div className=" flex  justify-center   absolute    w-screen h-[640px] mt-20 overflow-hidden">
        ...
        <div className="flex flex-col gap-6">
            ...
            <select className="border-b-1 border-gray-300  py-2 w-[240px]  outline-none text-[#b4aab4]">
              ...
              <div className="flex flex-col gap-1 h-130">
              <label className="font-semibold">MESSAGE</label>
              <input type='text' className="border-b-1 border-gray-300 text-[#b4aab4] py-10    w-[560px]   outline-none focus:border-teal-500 focus:border-b-2 transition-all" placeholder="Your Message"></input>
              </div>
