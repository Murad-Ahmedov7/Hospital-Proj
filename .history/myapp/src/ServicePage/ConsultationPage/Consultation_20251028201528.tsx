...
export default function Consultation() {
  ...
  // };
  return (
    <div className="relative w-screen min-h-screen  overflow-hidden flex items-center justify-center pt-4">
      <img
      ...
      <div className=" flex   absolute    w-screen h-[700px] mt-20 overflow-hidden">
