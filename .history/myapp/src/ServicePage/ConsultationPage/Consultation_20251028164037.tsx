      ...
      <div className=" flex  justify-center  absolute    w-screen h-[700px] mt-20 overflow-hidden">
        ...
        <div className="bg-[#424242] w-[372px] h-[812px] "> {/* umumi col dic */}
          ...
          <div className="flex   w-full h-12  ">
            <button className=" bg-cyan-500 w-60  rounded-[10px] flex items-center justify-center gap-3 hover:bg-blue-900   transition duration-1000 ease-in-out focus:ring-4  ">
