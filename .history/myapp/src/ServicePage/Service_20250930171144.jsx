    ...
    return (
        <div id="services" className="flex flex-col gap-12 min-h-screen ">
            ...
            <div className="grid grid-cols-3 grid-rows-2 ml-40 px-60 ">
                <div className=" bg-red-200  h-[330px] min-w-[400px] flex flex-col gap-5 py-7 px-10 ">
                ...
                <p className="font-mulisg text-[20px] text-[#7D7987] ">Choose your doctor from thousands of specialist, general, and trusted hospitals</p>
                </div>
                <div className=" bg-blue-200  h-[330px] min-w-[400px] ">2</div>
                <div className=" bg-green-200  h-[330px] min-w-[400px] ">3</div>
                <div className=" bg-yellow-200  h-[330px] min-w-[400px] ">4</div>
                <div className=" bg-purple-200  h-[330px] min-w-[400px] ">5</div>
                <div className=" bg-pink-200  h-[330px] min-w-[400px] ">6</div>
            </div>
