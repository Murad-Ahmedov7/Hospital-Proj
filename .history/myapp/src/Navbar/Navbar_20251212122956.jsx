...
// | Nə üçün ViewModel-də?                      | Niyə komponentdə qalır?                          |
// | ------------------------------------------ | ------------------------------------------------ |
// | Reactive state, effect, async əməliyyatlar | Statik data və UI-specific event handler         |
// | Backend ilə əlaqəli data / business logic  | Komponentə bağlı navigation və DOM əməliyyatları |
