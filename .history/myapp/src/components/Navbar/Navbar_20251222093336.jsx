...
{/* overflow-x-hidden */}
  ...
  <div className="flex items-center gap-4">
    <button className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
      <IoIosLogIn size={20} />
      <Link to='/auth/sign-up'>{t("navbar.signup")}</Link>
    </button>
      ...
      {isOpen && (
          <div className="absolute top-full right-0 bg-white shadow-lg px-5 py-3 flex flex-col gap-2 z-30">
            {userMenuItems.map(item => {
              ...
              return (
              <Link to="services/pharmacy/basket" key={item.id} className="flex items-center gap-2 hover:bg-gray-200">
...
// #region 🌟 Components Qovluğu — Sual-Cavabla

// ❓ Sual 1: Components qovluğu nə üçündür?
// ✅ Cavab: Layihədəki UI-nin kiçik və təkrar istifadə oluna bilən hissələrini saxlamaq üçün.
// (düşün: bu qovluq “lego blokları” kimidir — səhifəni burada toplayırsan)

// ❓ Sual 2: Burada nə saxlanılır?
// ✅ Cavab: Kiçik React komponentləri:

// Button 🟦 — düymələr

// Navbar 🟪 — səhifənin üst menyusu

// Card 🟩 — məhsul və ya məlumat kartları

// Modal 🟧 — açılıb-bağlanan pəncərələr

// ❓ Sual 3: Hər komponent nə üçün istifadə olunur?

// Button → Kliklənə bilən düymə funksiyası

// Navbar → Saytın naviqasiyasını göstərir

// Card → Məhsul/məlumat vizual təqdimatı

// Modal → Pop-up pəncərə açır

// ❓ Sual 4: Niyə ayrıca qovluqda saxlanılır?
// ✅ Cavab:

// Kod qarışmır

// Təkrar istifadə rahat olur

// Layihə böyüdükcə idarəsi asanlaşır

// ❓ Sual 5: Components səhifələrdən fərqlidirmi?
// ✅ Cavab:

// Səhifələr (pages) → bir UI səhifəsini təşkil edir

// Components → səhifəni kiçik bloklara bölür, təkrar istifadə üçün
