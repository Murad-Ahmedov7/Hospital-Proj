...
<div className={`  bg-gradient-to-bl from-gray-200/90 to-gray-400/10 px-5 flex-shrink-0 lg:w-80 xl:w-100 2xl:w-[450px]  min-h-130 rounded-xl shadow-lg group   ${isPharmacyShopPage ? `${styles.customW355} ${styles.customW500}` : ""} `}>
      <div className="flex h-[68%] justify-center items-center pt-6 ">
        ...
        />
<div className="border border-white rounded-full mb-60 ml-5 bg-white w-[40px] h-[40px] flex items-center justify-center">
  <CiHeart size={24} />
</div>
