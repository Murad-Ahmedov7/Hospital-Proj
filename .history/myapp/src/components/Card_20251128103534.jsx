...
<div className={`bg-gradient-to-bl from-gray-200/90 to-gray-400/10 px-5 flex-shrink-0 lg:w-80 xl:w-100 2xl:w-120 min-h-130 rounded-xl shadow-lg group ${styles.customW355}`}>
