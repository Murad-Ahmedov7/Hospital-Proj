export default function SignUp() {
  return (
    <div className="relative w-screen min-h-screen overflow-hidden">
      ...
      {/* Right cyan panel with gradient edge */}
      <div className="absolute right-0 top-0 h-full w-[600px] opacity-80 bg-cyan-500">
        {/* Gradient for smooth transition */}
        <div className="absolute left-0 top-0 h-full w-20 bg-gradient-to-l from-cyan-500 to-transparent"></div>
      </div>
      ...
      <div className="relative z-10 flex justify-end min-h-screen pt-[70px]">
        <div className="w-[600px] px-10 py-12 text-white flex flex-col gap-6">
          ...
          {/* Submit */}
          <button
            className="mt-4 bg-cyan-500 hover:bg-cyan-600 transition-colors text-white py-3 rounded-lg font-semibold shadow-md"
          >
            Sign Up
          </button>
