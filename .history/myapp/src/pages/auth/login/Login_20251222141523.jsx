  ...
  return (
    <div className="relative w-screen min-h-screen pt-[72px] overflow-hidden">
      ...
      <img
        ...
        alt="Cyan background"
        className="absolute right-0 top-0 pt-[82px] h-full w-[35%]  opacity-70 object-cover"
      />

        <div className=" absolute left-[73%] -translate-y-1/3  justify-center items-center  h-[70%] w-[20%]  flex  flex-col gap-16 overflow-hidden ">
