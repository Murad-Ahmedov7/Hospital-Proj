...
export default function Login() {
  return (
    <div className="relative w-screen min-h-screen pt-[72px] overflow-hidden">
      ...
      <div className=" absolute right-10 justify-center items-center  h-[70%] w-[30%]  flex  flex-col gap-16">
        ...
        <div className="text-white flex flex-col items-center gap-4 ">
          ...
          <div className="flex flex-col gap-1 w-full">
            ...
            <input
              ...
              className="px-4 py-3 rounded-lg bg-white/90 text-black shadow-sm border border-white/20 focus:outline-none focus:ring-2 focus:ring-cyan-400 w-[500px]"
            />
          </div>
