...
export default function Login() {
  return (
    ...
    <button className="flex items-center gap-2 px-4 py-2 bg-white text-black rounded-lg shadow hover:bg-gray-100">
      <img src="/images/google-icon.png" alt="Google" className="w-4 h-4 sm:w-5 sm:h-5 object-contain" />
