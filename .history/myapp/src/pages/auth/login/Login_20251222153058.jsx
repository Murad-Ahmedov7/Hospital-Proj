...
export default function Login() {
  return (
    ...
    "
          ...
          <div className="flex  lg:w-[80%] xl:w-[70%] justify-between">
            ...
            <Link className=" lg:text-sm  xl:text-base font-bold">Forgot password?</Link>
                  ...
                  <div className="button-wrapper w-full sm:w-[80%] xl:w-[70%]">
          <button
            type="submit"
            className="w-full py-3 bg-cyan-500 hover:bg-cyan-600 transition-colors text-white font-semibold rounded-lg"
          >
            Login
          </button>
        </div>
