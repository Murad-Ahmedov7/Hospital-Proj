  ...
  return (
    <div className="relative w-screen min-h-screen pt-[72px] overflow-hidden">
      ...
      <img
        ...
        alt="Cyan background"
        className="absolute right-0 top-0 h-full w-[40%] overflow-hidden  opacity-70 object-cover"
      />

      <div className=" absolute right-20 justify-center items-center  h-[70%] w-[500px]  flex  flex-col gap-16">
