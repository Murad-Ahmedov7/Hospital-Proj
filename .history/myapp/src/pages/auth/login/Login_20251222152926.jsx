    ...
    "
          ...
          <div className="flex  lg:w-[80%] xl:w-[70%] justify-between">
            ...
            <div className="flex gap-3">
                  <input type="checkbox" />
            <label className="text-white lg:text-[14px] xl:text-base font-bold">Remember me</label>
            </div>

            <Link className=" lg:text-[14px]  xl:text-base font-bold">Forgot password?</Link>
