  ...
  return (
    <div className="relative w-screen min-h-screen pt-[72px] overflow-hidden">
      ...
      <img
        ...
        alt="Cyan background"
        className="absolute right-0 top-0 pt-[72px] h-full w-[35%]  opacity-70 object-cover overflow-hidden"
      />

        <div className=" relative right-0 justify-center items-center  h-[70%] w-[40%]  flex  flex-col gap-16 ">
