...
export default function Login() {
  return (
    <div className="relative w-screen min-h-screen pt-[72px] overflow-hidden">
      ...
      <div className=" absolute right-0  justify-center h-[70%] w-[450px]  flex  flex-col gap-22">
        ...
        <div className="text-white">
          ...
          <p className="text-white text-2xl">Welcome back! Please enter your details</p>
        </div>
