  ...
  return (
    <div className="relative w-screen min-h-screen pt-[72px] overflow-hidden">
      ...
      <img
        ...
        alt="Cyan background"
        className="absolute right-0 top-0 h-full w-[35%]  opacity-70 object-cover"
      />

      <div className=" absolute right-0 justify-center items-center  h-[70%] w-[40%]  flex  flex-col gap-16">
        ...
        <div className="text-white flex flex-col items-center gap-4 ">
          ...
          {/* Username */}
          <div className="flex flex-col gap-1 w-[100%] pl-[1000px]">
