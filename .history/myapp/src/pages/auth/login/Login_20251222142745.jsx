...
export default function Login() {
  return (
    <div className="relative w-screen min-h-screen pt-[72px] overflow-hidden">
      ...
      {/* Right cyan panel */}
    <div className="absolute right-0 top-0 pt-[72px] h-full w-[35%] opacity-70 overflow-hidden">
      <img
      ...
      <div className="absolute inset-0 flex justify-center items-center">
        {/* bura logo, text, form gələcək */}
      </div>
    </div>
       
       
        {/* <div className=" absolute  top-[10%] left-1/2 -translate-x-1/2 h-[80%] w-[31%]   justify-center items-center   flex  flex-col gap-16 overflow-hidden ">
