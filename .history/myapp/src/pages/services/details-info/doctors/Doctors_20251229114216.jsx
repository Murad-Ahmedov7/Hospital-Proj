  ...
  return (
    <div className="pt-[72px] flex flex-col gap-14 w-screen h-screen ">
      ...
      <div className="main flex items-center justify-center w-full h-full">
        <div className=" w-[78%] h-[100%] flex justify-center header-row ">


          <div className="w-[30%] h-[10%] department-filter">
            <select className="border-1 border-gray-500 w-[62%] h-[55px]">
              <option>All</option>
          ...
          <div className="dt-sc-doctors-sorting bg-cyan-400">
            {
