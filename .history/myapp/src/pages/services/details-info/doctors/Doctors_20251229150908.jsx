  ...
  return (
    <div className="pt-[72px] flex flex-col gap-14 w-screen h-screen ">
      ...
      <div className="main flex justify-center  w-[100%] h-[100%]">
        ...
        <div className=" flex  w-[90%] h-[80%] justify-center items-start sil ">

        <div className="  xl:w-[98%] 2xl:w-[100%]    flex items-center justify-center 2xl:pr-22   header-row  ">
          <div className=" lg:w-[24%] xl:w-[17%]   h-[10%] department-filter flex ">
          ...
          <div className="dt-sc-doctors-sorting  flex lg:w-[77%] xl:w-[75%] 2xl:w-[45%] lg:flex-wrap xl:flex-nowrap lg:justify-center lg:pt-19 xl:pt-0 xl:justify-start   ">
