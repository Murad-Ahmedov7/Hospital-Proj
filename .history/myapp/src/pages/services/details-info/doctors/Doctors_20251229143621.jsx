  ...
  return (
    <div className="pt-[72px] flex flex-col gap-14 w-screen h-screen ">
      ...
      <div className="main flex justify-center  w-[100%] h-[100%]">
        ...
        <div className=" flex  w-[85%] h-[80%] justify-center">

        <div className=" w-[88%]   flex items-center justify-center   header-row  ">
          <div className="w-[20%] flex-shrink-0  h-[10%] department-filter flex ">
          ...
          <div className="dt-sc-doctors-sorting flex w-[80%]   ">
