    ...
    <div className="pt-[72px] flex flex-col gap-14 w-screen h-screen ">
      ...
      <div className="main flex justify-center  w-[100%] h-[100%]">
        ...
        <div className="  xl:w-[98%] 2xl:w-[100%]    flex items-center justify-center 2xl:pr-22    header-row  ">
          <div className=" lg:w-[25%] lg:pt-[61px] xl:w-[17%]   h-[10%] department-filter flex ">
            ...
            <div className="dt-sc-doctors-sorting  flex   lg:pt-15 lg:justify-center  lg:w-[77%] lg:flex-wrap  xl:w-[75%]   xl:justify-start xl:flex-nowrap  2xl:w-[65%]       ">
