  ...
  return (
    <div className="pt-[72px] flex flex-col gap-14 w-screen h-screen ">
      ...
      <div className=" flex items-center justify-center w-[100%]   mt-6 bg-gray-200 h-[180px]">
        <div className="  lg:w-[80%] xl:w-[80%] 2xl:w-[67%] ">
      ...
      <div className="main flex justify-center 2xl:justify-start  w-[100%] h-[100%]">
        ...
        <div className="  xl:w-[98%] 2xl:w-[100%]    flex items-center justify-center     header-row  ">
          <div className=" lg:w-[25%] flex-shrink-0 2xl:w-[18%]  xl:w-[17%]   h-[10%] department-filter flex ">
            ...
            <div className="dt-sc-doctors-sorting  flex flex-shrink-0    lg:justify-center  lg:w-[77%] lg:flex-wrap lg:pt-[56px] xl:pt-0  xl:w-[75%]   xl:justify-start xl:flex-nowrap  2xl:w-[45%]       ">
