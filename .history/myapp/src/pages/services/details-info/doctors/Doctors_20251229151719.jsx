...
export default function Doctors() {
  ...
  return (
    <div className="pt-[72px] flex flex-col gap-14 w-screen min-h-screen">

      {/* Header */}
      <div className="flex items-center justify-center mt-6 bg-gray-200 h-[180px]">
        <div className="lg:w-[92%] xl:w-[86%] 2xl:w-[68%]">
          <p className="font-bold text-4xl">Doctors</p>
        </div>
      </div>
      ...
      <div className="main flex justify-center w-full">
        <div className="w-full flex justify-center">
          ...
          <div className="header-row flex items-center w-full lg:w-[92%] xl:w-[86%] 2xl:w-[68%]">

            {/* Department Filter */}
            <div className="department-filter flex lg:w-[22%] xl:w-[16%] 2xl:w-[14%] shrink-0">
