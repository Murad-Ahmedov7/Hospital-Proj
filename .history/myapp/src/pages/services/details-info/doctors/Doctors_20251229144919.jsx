  ...
  return (
    <div className="pt-[72px] flex flex-col gap-14 w-screen h-screen ">
      ...
      <div className=" flex items-center justify-center  mt-6 bg-gray-200 h-[180px]">
        <div className="xl:w-[85%] 2xl:w-[68%]">
      ...
      <div className="main flex justify-center  w-[100%] h-[100%]">
        ...
        <div className=" 2xl:w-[93%] xl:w-[98%]   flex items-center justify-center   header-row  ">
          <div className="   h-[10%] department-filter flex ">
          ...
          <div className="dt-sc-doctors-sorting flex xl:w-[75%] 2xl:w-[45%]   ">
            {alphabetList.map((item) => (
              <div className="border-1 border-gray-500/40 py-4 px-2 ">
