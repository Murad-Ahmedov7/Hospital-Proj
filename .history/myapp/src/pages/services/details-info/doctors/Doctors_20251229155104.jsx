      ...
      <div className="main flex justify-center 2xl:justify-start  w-[100%] h-[100%]">
        ...
        <div className="  xl:w-[98%] 2xl:w-[100%]    flex items-center justify-center     header-row  ">
          <div className=" lg:w-[25%] 2xl:w-[18%]  xl:w-[17%]   h-[10%] department-filter flex ">
            ...
            <div className="dt-sc-doctors-sorting  flex    lg:justify-center  lg:w-[77%] lg:flex-wrap lg:pt-[56px] items-center  xl:w-[75%]   xl:justify-start xl:flex-nowrap  2xl:w-[45%]       ">
