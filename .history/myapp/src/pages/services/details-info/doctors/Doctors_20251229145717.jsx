  ...
  return (
    <div className="pt-[72px] flex flex-col gap-14 w-screen h-screen ">
      ...
      <div className=" flex items-center justify-center  mt-6 bg-gray-200 h-[180px]">
        <div className=" lg:w-[78%] xl:w-[85%] 2xl:w-[57%]">
      ...
      <div className="main flex justify-center  w-[100%] h-[100%]">
        ...
        <div className="  xl:w-[98%] 2xl:w-[93%]    flex items-center justify-center   header-row  ">
          <div className="lg:w-[27%] xl:w-[23%]   h-[10%] department-filter flex ">
          ...
          <div className="dt-sc-doctors-sorting  flex lg:w-[73%] xl:w-[75%] 2xl:w-[45%] lg:flex-wrap xl:flex-nowrap   ">
