  ...
  return (
    <div className="pt-[72px] flex flex-col gap-14 w-screen h-screen ">
      ...
      <div className="main flex justify-center  w-[100%] h-[100%]">
        ...
        <div className="  xl:w-[98%] 2xl:w-[100%]    flex items-center justify-center 2xl:pr-22 lg-pt-[20px]   header-row  ">
          <div className=" lg:w-[25%] xl:w-[17%]   h-[10%] department-filter flex ">
