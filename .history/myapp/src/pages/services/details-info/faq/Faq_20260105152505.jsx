  ...
  return (
    <div className="w-full min-h-screen pt-[72px] ">
      <div className="flex flex-col gap-6 items-center justify-center w-full h-full mt-20 ">
        ...
        <div className="mt-8 flex justify-center w-[70%]  flex-col gap-8  ">
          {/* {[...Array(5)].map((_, i) => ( */}

          {faqItems.map((item) => (
            <div
              key={item.id}
              className="flex gap-10 justify-start w-full  font-oswald"
            >
              {item.row.map((qa, i) => (
                <div className="flex flex-col gap-4  border-1 rounded-2xl   border-gray-400/60 p-4 min-w-[400px]" key={i}>
