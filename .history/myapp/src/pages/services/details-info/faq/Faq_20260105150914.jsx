      ...
      <div className="flex flex-col gap-6 items-center justify-center w-full h-full ">
        ...
        <div className="mt-8 flex justify-center w-[60%]  flex-col gap-8  ">
          ...
          {faqItems.map((item) => (
            <div
              key={item.id}
              className="flex gap-10 justify-start w-[71vw] text-black font-oswald"
            >
              {item.row.map((qa, i) => (
                <div className="flex flex-col gap-4  border-1 rounded-2xl   border-cyan-400/20 p-4 w-[70%]" key={i}>
