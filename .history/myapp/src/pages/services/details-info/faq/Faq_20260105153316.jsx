...
export default function Faq() {
  ...
  return (
    <div className="w-full min-h-screen pt-[72px] ">
      <div className="flex flex-col gap-6 items-center justify-center w-full h-full mt-20 ">
        {/*content div*/}
        ...
        <div className="mt-8 flex  flex-col items-center   w-[100%]  gap-8  ">
          {/* {[...Array(5)].map((_, i) => ( */}

          {faqItems.map((item) => (
            <div
              key={item.id}
              className="flex gap-10 justify-center  w-[90%] 2xl:w-[70%]  font-oswald"
            >
              {item.row.map((qa, i) => (
                <div className="flex flex-col gap-4  border-1 rounded-2xl   border-gray-400/60 p-4 w-[100%]" key={i}>
                  <div className="flex justify-between">
                    <p className="text-[20px] text-center font-oswald font-semibold">
                      {qa.question}
                    </p>
