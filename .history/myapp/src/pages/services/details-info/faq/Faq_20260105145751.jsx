  ...
  return (
    <div className="w-full h-screen pt-[72px] ">
      <div className="flex flex-col gap-6 items-center justify-center w-full h-full ">
        ...
        <div className="mt-8 flex justify-center w-full  flex-col gap-8 xl:max-w-[1100px] 2xl:max-w-[1400px] ">
          {/* {[...Array(5)].map((_, i) => ( */}
          ...
          {faqItems.map((item) => (
            ...
            >
              {item.row.map((qa, i) => (
                <div className="flex flex-col gap-4  border-1 border-gray-400/20 p-3 w-[40%]" key={i}>
