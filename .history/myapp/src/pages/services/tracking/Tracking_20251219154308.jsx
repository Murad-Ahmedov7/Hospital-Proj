...
import TrackingVm from "./TrackingVm";
...
export default function Tracking() {
 ...
 const {
  ...
  return (
   ...
   <img className="absolute inset-0  object-cover w-full h-full " src="/images/tracking page/time_tracking_for_developers.jpg" alt="Image not found "/>
