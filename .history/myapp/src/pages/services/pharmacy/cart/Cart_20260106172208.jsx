...
import BasketVm from "./BasketVm";
import BasketHero from "./CartHero";
...
export default function Basket() {
  ...
  const { productQuantity, itemsCount, increaseCount, decreaseCount } =BasketVm();
              ...
              <div className="flex w-full items-center  "> {/*bir row*/}
                ...
                <div className="flex gap-5 w-[35%]  ">   {/*sekil ve aciqlamalari*/} 
                 ...
                 <div className="bg-[#f1f5f9] w-[100px] h-[93px] flex items-center justify-center  rounded-2xl ">
                  <img className="w-[60px] h-[56px]" src="/images/pharmacy page/popular products/product1.png " alt="image not found" />
                </div>
