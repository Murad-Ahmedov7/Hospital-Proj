  ...
  return (
    <div className="flex flex-col justify-center items-center  gap-7 ">
      ...
      <Swiper
        ...
        className="lg:w-[1000px] xl:w-[1300px] 2xl:w-[1800px] flex justify-center items-center relative"
      >
        {slides.map((s, i) => (
          <SwiperSlide key={i}>
            {/* <Card s={s} /> */}

            <div className={`  bg-gradient-to-bl from-gray-200/90 to-gray-400/10 px-5 flex-shrink-0 lg:w-80 xl:w-100 2xl:w-[450px]  min-h-130 rounded-xl shadow-lg group `}>
