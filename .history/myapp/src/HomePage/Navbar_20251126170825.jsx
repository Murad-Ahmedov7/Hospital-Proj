...
const { t, i18n } = useTranslation(); 
    ...
    return (
        ...
        <div className={`fixed  w-[100%]  z-20 flex justify-between  items-center px-5 lg:px-20 max-w-screen py-4 bg-white transition-all duration-700 ease-in-out ${firstScrollDone ? "border-2 border-cyan-500 rounded-3xl shadow-lg" : ""}`}>
