...
const { t, i18n } = useTranslation(); 
    ...
    return (
        <div className={`flex gap-10 2xl:justify-between  ${firstScrollDone? "border-4 h-18   bg-white":''}   justify-center  font-oswald text-[#1F1534]   fixed   w-full pr-[8%] lg:pl- lg:pr-[15%] 2xl:pr-[7%]  h-14 pt-6 rounded-[30px]  z-20 `}>
