...
const handleClick = (e) => {
    ...
    return (
        ...
        <div className="flex gap-10 2xl:gap-7 2xl:ml-20  lg:ml-3   justify-center font-oswald text-[#1F1534]   fixed   w-full pr-[8%] h-14 pt-6 rounded-[30px]  z-20   ">
           <div className=" lg:w-[350px] h-[100px] lg:mt-[-13px] 2xl:w-[30%]     "><img className="w-[200px] h-[50px]" src="/images/mediflow-logo.png" alt="Image not found" /></div>

           <div className="flex gap-10 xl:mr-5 2xl:justify-end 2xl:w-[14%] 2xl:ml-144   ">
                    {   
            links.map((link)=>(
                <a
                    key={link.id}
