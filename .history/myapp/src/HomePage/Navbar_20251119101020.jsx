...
import { Menu, Select } from '@headlessui/react'
...
//niye removu-isletdik???????
    ...
    return (
       ...
       <Select>
      <Select.Button className="p-2 border rounded bg-white w-[150px] text-left">
        Choose
      </Select.Button>

      <Select.Options className="absolute bg-white shadow-lg rounded mt-2 w-[150px]">
        {options.map((opt) => (
          <Select.Option
            key={opt.id}
            value={opt.label}
