    ...
    return (
        <div className=" min-h-screen ">
            ...
            <div className="flex justify-between w-[95%] ">
                ...
                <img className="sm:w-[284px]   sm:h-[270px] md:w-[340px] md:h-[340px] lg:w-[400px] lg:h-[400px]  xl-w-[500px] xl:h-[500px] mt-25" src="/images/trafalgar-header illustration 1.png" alt="Picture not found " />
            </div>
