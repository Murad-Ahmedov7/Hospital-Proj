...
const { t, i18n } = useTranslation(); 
    ...
    return (
        ...
        <div className={`flex gap-10 2xl:justify-between  lg:ml-3 ${firstScrollDone? "border-4":''}   justify-center font-oswald text-[#1F1534]   fixed   w-full pr-[8%] lg:pr-[] h-14 pt-6 rounded-[30px]  z-20 `}>
