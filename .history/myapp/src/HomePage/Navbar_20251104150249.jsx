...
const handleClick = (e) => {
    ...
    return (
        ...
        <div className="flex gap-10 2xl:gap-2 lg:ml-3   justify-center font-oswald text-[#1F1534]   fixed   w-full pr-[8%] h-14 pt-6 rounded-[30px]  z-20   ">
           ...
           <div className="flex gap-10 xl:mr-5 2xl:justify-end 2xl:w-[15%]   ">
                    {   
            links.map((link)=>(
                <a
                    key={link.id}
           ...
           <div className="flex gap-4 2xl:justify-end 2xl:w-full">
