    ...
    return (
        <div className="bg-gradient-to-bl from-blue-300 to-gray-100" id="home ">
            ...
            <div className="flex justify-between w-[95%] xl:w-[85%]  ">
                ...
                <img className="  sm:w-[284px]   sm:h-[270px] md:w-[340px] md:h-[340px] lg:w-[500px] lg:h-[500px]  mt-25" src="/images/home pagetrafalgar-header illustration 1.png" alt="Picture not found " />
            </div>
