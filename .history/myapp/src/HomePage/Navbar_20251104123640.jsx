...
const handleClick = (e) => {
    ...
    return (
        ...
        <div className="flex gap-10 lg:ml-1   justify-center font-oswald text-[#1F1534]   fixed   w-full pr-[8%] h-14 pt-6 rounded-[30px]  z-20   ">
           <div className=" lg:w-[26%] h-[200px] lg:mt-[-13px]   "><img className="w-[2110px] h-[50px]" src="/images/mediflow-logo.png" alt="Image not found" /></div>
        {
            links.map((link)=>(
                <a
                    key={link.id}
