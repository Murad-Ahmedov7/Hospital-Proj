...
window.addEventListener("scroll", () => {
  if (!firstScrollDone) {
    ...
    // Burada istədiyin funksiyanı çağıra bilərsən
  }
});
    return (
        ...
        <div className={`flex gap-10 2xl:justify-between  lg:ml-3 ${firstScrollDone? "bg-red-700":''}'  justify-center font-oswald text-[#1F1534]   fixed   w-full pr-[8%] h-14 pt-6 rounded-[30px]  z-20 `}>
