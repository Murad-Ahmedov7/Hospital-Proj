    ...
    return (
        <div className=" min-h-screen ">
            ...
            <div className="flex justify-between w-[95%] ">
                ...
                <img className="w-[284px]   h-[270px] md:w-[340px] md:h-[340px] lg:w-[400px] lg:h-[400px] xl:h-[500px] xl-wmt-25" src="/images/trafalgar-header illustration 1.png" alt="Picture not found " />
            </div>
