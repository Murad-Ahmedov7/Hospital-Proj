...
const handleClick = (e) => {
    ...
    return (
        ...
        <div className="flex gap-10 lg:ml-10   justify-center font-oswald text-[#1F1534]   fixed   w-full pr-[8%] h-14 pt-6 rounded-[30px]  z-20   ">
        ...
        <button className="flex gap-3 ml-4 mt-[-6px] h-10 px-5 items-center   rounded-2xl border-1 text-white bg-gradient-to-br from-white to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-white dark:focus:ring-green-800 ">
           ...
           <button className="flex gap-2 ml-4 mt-[-6px] h-10 px-5 items-center   rounded-2xl border-1 text-white bg-gradient-to-br from-white to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-white dark:focus:ring-green-800 ">
            <IoIosLogIn  size={21}/>
