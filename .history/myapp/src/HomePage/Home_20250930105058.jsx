    ...
    return (
        <div className=" min-h-screen ">
            ...
            <div className="flex justify-between w-[80%]">
                <div className=" flex flex-col mt-35 font-bold font-mulish ml-[10%] h-[250px]   justify-between">
                ...
                <img className="w-[500px] h-[450px] " src="/images/trafalgar-header illustration 1.png" alt="Picture not found " />
            </div>
