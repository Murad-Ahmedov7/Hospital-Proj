...
//niye removu-isletdik???????
    ...
    return (
        ...
        <div className={`flex gap-10 2xl:justify-between  lg:ml-3 ${firstScrollDone? "border-4":''}    font-oswald text-[#1F1534]   fixed   min-w-screen pr-[8%] h-14 pt-6 rounded-[30px]  z-20 `}>
