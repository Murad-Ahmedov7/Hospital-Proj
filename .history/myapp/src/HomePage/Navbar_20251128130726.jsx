...
{/* overflow-x-hidden */}
  ...
  <div className="flex items-center gap-4">
    ...
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute top-full right-0 bg-white shadow-lg px-5 py-3 flex flex-col gap-2 z-30 group">
          <div className="flex items-center gap-2 group-hover:bg-gray-200"><FaBalanceScale size={20}/> {t("navbar.myShopping.balance",{ lng: currentLang })}</div>
          <div className="flex gap-2  group-hover:bg-gray-200">  <FaBalanceScale  size={20} /> Muqayise</div>
          <Link to='services/pharmacy/basket' className="flex items-center gap-2  group-hover:bg-gray-200"><RiShoppingBasketLine size={20}/> {t("navbar.myShopping.basket",{ lng: currentLang })}</Link>
          <div className="flex items-center gap-2  group-hover:bg-gray-200"><FaRegHeart size={20}/> {t("navbar.myShopping.favorites",{ lng: currentLang })}</div>
