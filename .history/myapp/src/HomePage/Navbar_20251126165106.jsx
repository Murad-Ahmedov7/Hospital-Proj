...
const { t, i18n } = useTranslation(); 
    ...
    return (
        ...
        <div className={`fixed top-0 w-[89%] overflow-x-auto z-20 flex justify-between  items-center px-5 lg:px-30 py-4 bg-white transition-all duration-700 ease-in-out ${firstScrollDone ? "border-2 border-cyan-500 rounded-3xl shadow-lg" : ""}`}>
