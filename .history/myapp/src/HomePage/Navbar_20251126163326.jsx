...
const { t, i18n } = useTranslation(); 
    ...
    return (
        ...
        <div className={`fixed top-0 w-full z-20 flex justify-between overflow-x-hidden   items-center px-5 lg:px-20 py-4 bg-white transition-all duration-700 ease-in-out ${firstScrollDone ? "border-2 border-cyan-500 rounded-3xl shadow-lg" : ""}`}>
  <Link to="/" className="flex-shrink-0 w-32 lg:w-40 ">
    <img src="/images/mediflow-logo.png" alt="Logo" className="w-full h-auto"/>
  </Link>

{/* overflow-x-hidden */}
  <div className="lg:flex gap-8  2xl:w-[550px]  justify-end xl:w-[400px]     ">
    {links.map(link => (
