...
const { t, i18n } = useTranslation(); 
    ...
    return (
        ...
        <div className={`flex gap-10 2xl:justify-between  lg:ml-3 ${firstScrollDone? "border-4":''}   justify-center font-oswald text-[#1F1534]   fixed   w-full pr-[8%] lg:pr-[15%] 2xl:pr-[0%]  h-14 pt-6 rounded-[30px]  z-20 `}>
           <Link to='/' className=" w-[340px] xl:w-[340px] lg:w-[170px] lg:ml-[80px] flex-shrink-0 h-[100px] lg:mt-[-13px] 2xl:w-[30%] 2xl:ml-[8%]"><img className="w-[200px] h-[50px]" src="/images/mediflow-logo.png" alt="Image not found" /></Link>

           <div className="flex gap-10 lg:min-w-[420px]  xl:mr-5 2xl:justify-end 2xl:w-[14%]   ">
                    {   
            links.map((link)=>(
                <a
                    key={link.id}
            ...
            <div className="flex gap-4 w-[400px] lg:min-w-[310px]  ">
          <button className="flex gap-3   mt-[-6px] h-10 lg:w-28 xl:w-40 lg:px-1 px-5 justify-center   items-center    rounded-2xl border-1 text-white bg-gradient-to-br from-white to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-white dark:focus:ring-green-800 ">
              <IoIosLogIn  size={20}/>
