...
const { t, i18n } = useTranslation(); 
    ...
    return (
        ...
        <div className={`flex gap-10 2xl:justify-between  ${firstScrollDone? "border-4 h-112  bg-white":''}   justify-center  font-oswald text-[#1F1534]   fixed   w-full pr-[8%] lg:ml-14 lg:pr-[15%] 2xl:pr-[7%]  h-14 pt-6 rounded-[30px]  z-20 `}>
           ...
           <div className="flex gap-10 lg:min-w-[420px]  xl:mr-5   2xl:w-[14%]   ">
            ...
            <div className="flex gap-4 w-[400px] lg:min-w-[310px] xl:min-w-[350px] items-center  ">
