...
const { t, i18n } = useTranslation(); 
    ...
    return (
        ...
        <div className={`flex gap-10 2xl:justify-between  lg:ml-14 ${firstScrollDone? "border-4":''}   justify-center font-oswald text-[#1F1534]   fixed   w-full pr-[8%] lg:pr-[15%] 2xl:pr-[7%]  h-14 pt-6 rounded-[30px]  z-20 `}>
           ...
           <div className="flex gap-10 lg:min-w-[420px]  xl:mr-5 items-center 2xl:justify-center 2xl:w-[14%]   ">
                    {   
            links.map((link)=>(
                <a
                    key={link.id}
