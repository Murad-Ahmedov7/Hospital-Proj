...
export default function Home() {
    ...
    return (
        <div className=" min-h-screen flex ju ">
            <Navbar/>
            <div className=" flex flex-col mt-35 font-bold font-mulish ml-[10%] gap-6 justify-center
            ">
            ...
            <img className="w-[500px] h-[450px] ml-[45%] mt-[-27%]  " src="/images/trafalgar-header illustration 1.png" alt="Picture not found " />
            </div>
