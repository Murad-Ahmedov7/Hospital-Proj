    ...
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute top-full right-0 bg-white shadow-lg px-5 py-3 flex flex-col gap-2 z-30 ">
          ...
          <Link to='services/pharmacy/basket' className="flex items-center gap-2  hover:bg-gray-200 w-200"><RiShoppingBasketLine size={20}/> {t("navbar.myShopping.basket",{ lng: currentLang })}</Link>
