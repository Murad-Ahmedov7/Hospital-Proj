...
//niye removu-isletdik???????
    ...
    return (
        ...
        <div className={`flex gap-10 2xl:justify-between  lg:ml-3 ${firstScrollDone? "border-4":''}   justify-center font-oswald text-[#1F1534]   fixed   w-full pr-[8%] h-14 pt-6 rounded-[30px]  z-20 `}>
           <Link to='/' className=" lg:w-[350px] h-[100px] lg:mt-[-13px] 2xl:w-[30%] 2xl:ml-[8%]"><img className="w-[200px] h-[50px]" src="/images/mediflow-logo.png" alt="Image not found" /></Link>
        ...
        {/* <button className="flex gap-3 mr-1 mt-[-6px] h-10 lg:w-30 xl:w-40  items-center justify-center       rounded-2xl border-1 text-white bg-gradient-to-br from-white to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-white dark:focus:ring-green-800 ">
         ...
         <div className="flex flex-col gap-1 h-100  ">
          {/* <div className="bg-white rounded-2xl px-5"><FaBalanceScale  size={18} /> <span>Balance</span></div>
          <div className="bg-white rounded-2xl px-5"><FaRegHeart size={18} /> <span>Favorites</span></div>  
          <div className="bg-white rounded-2xl px-5"><RiShoppingBasketLine size={18} /> <span>Basket</span></div>         */}
         <div className="bg-white rounded-2xl px-5">
          <div className="flex gap-2">  <FaBalanceScale  size={18} /> <span>Balance</span></div>
          div className="flex gap-2"><FaRegHeart   size={18} /> <span>Favorites</span>
          <RiShoppingBasketLine  size={18} /> <span>Basket</span>
          </div>
         ...
         <Menu>
      <Menu.Button className="p-2 border rounded">Choose</Menu.Button>

      <Menu.Items className="absolute mt-2 bg-white shadow rounded p-2">
        <Menu.Item>
          <div className="flex items-center gap-2 cursor-pointer p-2 hover:bg-gray-100">
            <FaBalanceScale size={18} /> <span>Balance</span>
          </div>
        </Menu.Item>

        <Menu.Item>
          <div className="flex items-center gap-2 cursor-pointer p-2 hover:bg-gray-100">
            <FaRegHeart size={18} /> <span>Favorites</span>
          </div>
        </Menu.Item>
