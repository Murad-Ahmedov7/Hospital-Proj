...
const { t, i18n } = useTranslation(); 
    ...
    return (
        ...
        <div className={`flex gap-10 2xl:justify-between  lg:ml-3 ${firstScrollDone? "border-4":''}   justify-center font-oswald text-[#1F1534]   fixed   w-full pr-[8%] lg:pr-[15%]  h-14 pt-6 rounded-[30px]  z-20 `}>
           <Link to='/' className=" w-[340px] lg:w-[220px] flex-shrink-0 h-[100px] lg:mt-[-13px] 2xl:w-[30%] 2xl:ml-[8%]"><img className="w-[200px] h-[50px]" src="/images/mediflow-logo.png" alt="Image not found" /></Link>
