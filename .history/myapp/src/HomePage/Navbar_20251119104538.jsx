...
import { FaRegHeart } from "react-icons/fa";
import { RiShoppingBasketLine } from "react-icons/ri";
         <div className="bg-white justify-center   rounded-xl px-5 flex flex-col gap-5 h-[140px]">
          <div className="flex gap-2">  <FaBalanceScale  size={18} /> <span>Balance or Compare</span></div>
          <div className="flex gap-2">  <RiShoppingBasketLine  size={18} /> <span>Balance</span></div>
