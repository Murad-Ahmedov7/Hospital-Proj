...
<div className={`fixed top-0 left-0 right-0 z-20 flex justify-between items-center px-5 md:px-10 lg:px-50 py-4 bg-white max-w-screen-2xl mx-auto transition-all duration-700 ease-in-out ${firstScrollDone ? "border-2 border-cyan-500 rounded-3xl shadow-lg" : ""}`}>
