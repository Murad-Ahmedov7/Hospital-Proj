...
export default function Home() {
    ...
    return (
        <div className=" min-h-screen pb-[55%]">
            <Navbar/>
            <div className=" flex flex-col mt-35 font-semibold font-mulish ml-[10%] gap-6 justify-center
            ">
            ...
            <img className="w-[500px] h-[450px] ml-[35%] mt-[-29%]  " src="/images/trafalgar-header illustration 1.png" alt="Picture not found " />
            </div>
