...
import Basket from "./ServicePage/PharmacyPage/Basket";
import DoctorTable from "./ServicePage/DoctorPage/DoctorTable";
    ...
    <>
      ...
      <Routes>
       <Route path="/" element={<AllHash />} />
        ...
        <Route path="services/doctor/table" element={<DoctorTable />} />
